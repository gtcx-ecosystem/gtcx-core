...
- 13 ADRs in `_sop/2-docs/3-engineering/6-decisions/` capture all significant architectural decisions
...
4. Read the relevant package spec in `_sop/2-docs/5-specs/4-backend/packages/`
...
- Using patterns that contradict `_sop/2-docs/3-engineering/code-standards.md` or existing packages
