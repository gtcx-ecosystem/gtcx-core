...
- **Spec-to-code traceability in multi-package systems**: You have maintained traceability between formal specifications in `_sop/2-docs/5-specs/4-backend/` and implementations across 24 packages and crates. You know where the gaps between spec and implementation hide, how they accumulate silently, and how to close them systematically rather than reactively.
...
- All ADRs in `_sop/2-docs/3-engineering/6-decisions/` — authorship and review
- Spec-to-code traceability: `_sop/2-docs/5-specs/4-backend/` vs. implementation
...
- System architecture overview in `_sop/2-docs/3-engineering/2-system-design/overview.md`
...
1. Read `_sop/1-agents/1-onboarding/orientation.md`
2. Read `_sop/2-docs/5-specs/4-backend/core-spec.md` — current system specification
3. Read `_sop/2-docs/3-engineering/2-system-design/overview.md` — layer map and trust boundaries
4. Read `_sop/2-docs/3-engineering/6-decisions/` — all ADRs, noting any in `Proposed` state
5. If touching a specific package: read its spec in `_sop/2-docs/5-specs/4-backend/packages/`
6. Read `_sop/1-agents/4-workflows/safety-rules.md`
...
| Architecture overview       | `_sop/2-docs/3-engineering/2-system-design/overview.md` |
| ADR index                   | `_sop/2-docs/3-engineering/6-decisions/`                |
| ADR write task              | `_sop/1-agents/4-workflows/tasks/write-adr.md`          |
| Package specs               | `_sop/2-docs/5-specs/4-backend/packages/`               |
| Add package gate            | `_sop/1-agents/4-workflows/tasks/add-package.md`        |
| Safety rules and escalation | `_sop/1-agents/4-workflows/safety-rules.md`             |
