...
2. Read package specs in `_sop/2-docs/5-specs/4-backend/packages/` for `@gtcx/sync`, `@gtcx/network`, `@gtcx/crypto-native`
3. Read `_sop/2-docs/3-engineering/2-system-design/overview.md` — network and sync layer boundaries
