...
- **Per release:** full gate sequence documented in `_sop/2-docs/4-devops/7-release-mgmt/release-checklist.md`
...
- [`_sop/2-docs/4-devops/2-runbooks/quality-runbook.md`](../../4-devops/2-runbooks/quality-runbook.md) — gate sequence and triage order
- [`_sop/2-docs/4-devops/7-release-mgmt/release-checklist.md`](../../4-devops/7-release-mgmt/release-checklist.md) — release checklist
- [`_sop/2-docs/3-engineering/6-decisions/011-architecture-boundary-enforcement.md`](../../3-engineering/6-decisions/011-architecture-boundary-enforcement.md) — ADR-011
- [`_sop/2-docs/3-engineering/6-decisions/013-api-baseline-and-performance-budget-gates.md`](../../3-engineering/6-decisions/013-api-baseline-and-performance-budget-gates.md) — ADR-013
