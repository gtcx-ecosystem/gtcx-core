...
- [`_sop/2-docs/5-specs/4-backend/core-spec.md`](../core-spec.md) — dependency rules (all packages may depend on `@gtcx/types`)
- [`_sop/2-docs/4-devops/2-runbooks/quality-runbook.md`](../../../4-devops/2-runbooks/quality-runbook.md) — API surface gate
