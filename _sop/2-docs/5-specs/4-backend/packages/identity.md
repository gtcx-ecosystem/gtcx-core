...
- [`_sop/2-docs/5-specs/4-backend/packages/crypto.md`](./crypto.md) — cryptographic primitives this package depends on
- [`_sop/2-docs/5-specs/4-backend/packages/verification.md`](./verification.md) — consumes identity for certificate signing
- [`_sop/2-docs/3-engineering/7-security/security-framework.md`](../../../3-engineering/7-security/security-framework.md) — identity and key management policy
