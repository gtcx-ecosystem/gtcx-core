...
- [`_sop/2-docs/5-specs/4-backend/packages/domain.md`](./domain.md) — domain event types
- [`_sop/2-docs/5-specs/4-backend/packages/sync.md`](./sync.md) — sync engine consumes events
