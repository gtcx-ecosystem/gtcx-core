...
All packages follow the security framework in `_sop/2-docs/3-engineering/7-security/security-framework.md`. Security-sensitive packages (`@gtcx/crypto`, `@gtcx/crypto-native`, `@gtcx/security`, `@gtcx/verification`, `@gtcx/identity`, `rust/gtcx-crypto`, `rust/gtcx-zkp`) require Cryptographic Security Engineer review on every change.

---

## Reference

- [`_sop/2-docs/5-specs/4-backend/core-spec.md`](../core-spec.md) — system specification
...
- [`_sop/1-agents/2-roles/crypto-security-engineer.md`](../../../../1-agents/2-roles/crypto-security-engineer.md) — gatekeeper for security-sensitive packages
