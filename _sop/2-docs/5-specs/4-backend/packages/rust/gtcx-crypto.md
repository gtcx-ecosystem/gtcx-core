...
- [`_sop/2-docs/5-specs/4-backend/packages/crypto.md`](../crypto.md) — TypeScript package that consumes this crate
- [`_sop/2-docs/3-engineering/7-security/security-framework.md`](../../../../3-engineering/7-security/security-framework.md) — approved libraries and cryptographic standards
