...
- [`_sop/2-docs/5-specs/4-backend/packages/rust/gtcx-crypto.md`](./gtcx-crypto.md) — Rust source
- [`_sop/2-docs/5-specs/4-backend/packages/crypto-native.md`](../crypto-native.md) — TypeScript consumer
- [`_sop/2-docs/4-devops/3-ci-cd-pipelines/ci-cd.md`](../../../../4-devops/3-ci-cd-pipelines/ci-cd.md) — native binding CI matrix
