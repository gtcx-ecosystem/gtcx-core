...
- [`_sop/2-docs/3-engineering/7-security/security-framework.md`](../../../../3-engineering/7-security/security-framework.md) — ZKP layer description and approved libraries
- [`_sop/2-docs/5-specs/4-backend/core-spec.md`](../../core-spec.md) — system overview
- [`_sop/2-docs/4-devops/3-ci-cd-pipelines/ci-cd.md`](../../../../4-devops/3-ci-cd-pipelines/ci-cd.md) — scheduled ZKP validation
