...
- [`_sop/2-docs/5-specs/4-backend/packages/rust/gtcx-network.md`](./gtcx-network.md) — vote propagation transport
- [`_sop/2-docs/5-specs/4-backend/packages/rust/gtcx-crypto.md`](./gtcx-crypto.md) — vote signing
