...
- [`_sop/2-docs/5-specs/4-backend/packages/crypto.md`](./crypto.md) — TS crypto package that consumes this
- [`_sop/2-docs/3-engineering/7-security/security-framework.md`](../../../3-engineering/7-security/security-framework.md) — cryptographic standards
- [`_sop/2-docs/4-devops/3-ci-cd-pipelines/ci-cd.md`](../../../4-devops/3-ci-cd-pipelines/ci-cd.md) — platform matrix CI
