...
- [`_sop/2-docs/3-engineering/2-system-design/overview.md`](../../3-engineering/2-system-design/overview.md) — architecture overview
- [`_sop/2-docs/3-engineering/2-system-design/api-stability.md`](../../3-engineering/2-system-design/api-stability.md) — API stability matrix
