...
- [`_sop/2-docs/5-specs/4-backend/core-spec.md`](../../5-specs/4-backend/core-spec.md) — system specification
- [`_sop/2-docs/3-engineering/6-decisions/`](../6-decisions/) — all ADRs
- [`_sop/2-docs/3-engineering/7-security/security-framework.md`](../7-security/security-framework.md) — security framework
- [`_sop/1-agents/4-workflows/safety-rules.md`](../../../1-agents/4-workflows/safety-rules.md) — what requires approval
