...
Full gate sequence: `_sop/2-docs/5-specs/6-testing/quality-standards.md`
...
| UAT evidence           | Manual review                                     | Update `_sop/3-agile/2-scrum-board/6-testing/uat-evidence-log.md`   |
...
- [`_sop/2-docs/5-specs/6-testing/quality-standards.md`](../../5-specs/6-testing/quality-standards.md) — full gate list and thresholds
