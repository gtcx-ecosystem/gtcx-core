...
**Product repo example:** [bout-progress-exploration-os.config.json](01-docs/04-ops/examples/bout-progress-exploration-os.config.json) — copy to exploration-os `.baseline/`.
