 ...
 * 01-docs/04-ops/repo-bootstrap.md is generated from the same array (run
 * `node 03-platform/tools/check-ops-prereqs.mjs --emit-doc` to regenerate it).
 */
...
const CHECKS = [
  ...
  },
  {
    ...
    remediate: () =>
      ...
      `       (see 01-docs/04-ops/repo-bootstrap.md for a templated payload)`,
  },
  {
...
async function emitDoc() {
  ...
  const docPath = path.join(process.cwd(), '01-docs/04-ops/repo-bootstrap.md');
