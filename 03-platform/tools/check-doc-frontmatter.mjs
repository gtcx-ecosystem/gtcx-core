 ...
 * @usage node 03-platform/tools/check-doc-frontmatter.mjs [file...]
 * @usage node 03-platform/tools/check-doc-frontmatter.mjs --diff [base-ref]
 */
...
const VALID_OWNERS = [
  ...
  'product-lead',
  'gtcx-core',
  'gtcx-agentic', // ecosystem rollout SSOT for 01-docs/04-ops/agent-*.md
];
...
const DEFAULT_EXCLUDES = [
  '**/README.md',
  '**/templates/**',
  '01-docs/01-agents/sessions/**',
  '01-docs/01-agents/workflows/agent-*.md',
  '01-docs/05-audit/**',
...
function getChangedFiles(baseRef) {
  try {
    ...
    return output
      .trim()
      .split('\n')
      .filter((f) => f.startsWith('01-docs/') && f.endsWith('.md'))
...
function main() {
  ...
  if (useDiff) {
    ...
    files = globSync('01-docs/**/*.md', { cwd: ROOT, absolute: true });
  }
