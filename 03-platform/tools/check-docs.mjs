 ...
 * - Validates that all specs in 01-docs/specs/core-spec.md match packages.
 */
...
checkMarkdownFile(path.join(rootDir, '01-docs/specs/core-spec.md'), tsPackages, 'core-spec.md');
checkMarkdownFile(path.join(rootDir, '01-docs/specs/core-spec.md'), rustCrates, 'core-spec.md');

// 3. Check Architecture Overview
checkMarkdownFile(
  path.join(rootDir, '01-docs/architecture/overview.md'),
  tsPackages,
  'overview.md'
);
