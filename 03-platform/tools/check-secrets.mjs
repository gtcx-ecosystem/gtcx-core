...
const allowlistedPrivateKeyFixtures = new Set([
  '03-platform/packages/api-client/tests/fixtures/mtls/ca.key',
  '03-platform/packages/api-client/tests/fixtures/mtls/client.key',
  '03-platform/packages/api-client/tests/fixtures/mtls/server.key',
]);
