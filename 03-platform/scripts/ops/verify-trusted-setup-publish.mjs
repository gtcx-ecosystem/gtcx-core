...
if (!existsSync(MANIFEST)) {
  fail(`missing ${MANIFEST} — copy 01-docs/05-audit/evidence/trusted-setup-manifest.template.json`);
}
...
if (
  ...
  manifest.transcript_sha256 !== '<sha256 of artifacts/trusted-setup/transcript.seed>'
) {
  ...
  console.warn(
    'verify-trusted-setup-publish: manifest transcript_sha256 still placeholder — fill before release'
  );
}

console.log(
  'verify-trusted-setup-publish: transcript OK (32 bytes, sha256=' + sha.slice(0, 16) + '…)'
);
