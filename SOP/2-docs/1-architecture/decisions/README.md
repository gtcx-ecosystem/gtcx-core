...
ADRs for `gtcx-core`. Each ADR documents a significant architectural decision, its context, and consequences.
...
Each ADR follows [template.md](template.md) with Status, Date, Context, Decision, and Consequences sections.
