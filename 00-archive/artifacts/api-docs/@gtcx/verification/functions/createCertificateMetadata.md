...
[GTCX Core API Reference](../../../README.md) / [@gtcx/verification](../README.md) / [](../README.md) / createCertificateMetadata
...
`string` = `'GTCX Verification System'`

## Returns

[`CertificateMetadata`](../interfaces/CertificateMetadata.md)
