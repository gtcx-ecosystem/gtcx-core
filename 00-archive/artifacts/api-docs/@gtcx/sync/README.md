...
[GTCX Core API Reference](../../README.md) / @gtcx/sync
...
- [ISyncEngine](interfaces/ISyncEngine.md)
- [SyncAuditEvent](interfaces/SyncAuditEvent.md)
- [SyncConflict](interfaces/SyncConflict.md)
- [SyncEngineConfig](interfaces/SyncEngineConfig.md)
- [SyncItem](interfaces/SyncItem.md)
- [SyncMetrics](interfaces/SyncMetrics.md)
...
- [SyncAuditEventType](type-aliases/SyncAuditEventType.md)
- [SyncStatus](type-aliases/SyncStatus.md)

## Functions

- [createSyncEngine](functions/createSyncEngine.md)
- [resolveConflict](functions/resolveConflict.md)
