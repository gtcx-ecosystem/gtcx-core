...
5. **Readiness scores:** Read `../01-docs/01-agents/readiness-and-audit-lanes.md` and `../01-docs/05-audit/latest.json` before citing 8.9, IC-T*, GR-T*, or GCR. Never use bank-grade **8.9** as engineering readiness.
...
**GCR today:** **GCR-T0** · **BLOCKED** — `../01-docs/05-audit/global-compliance-rating-2026-06-05.md`
