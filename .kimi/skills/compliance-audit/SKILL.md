...
description: GTCX lane-2 audit (lane 2; 2–4 hours)
---

# compliance-audit

Run the GTCX **compliance-audit** audit in **this repo** (`gtcx-core`).

## Steps

1. Read command spec: `../gtcx-docs/03-platform/tools/audit/audit-framework/commands/compliance-audit.md`
2. Read prompt (BEGIN PROMPT → END PROMPT): `../gtcx-docs/03-platform/tools/audit/audit-framework/prompts/lanes/compliance-audit-prompt.md`
3. Read scoring protocol: `../gtcx-docs/03-platform/tools/audit/lane-scoring/internal-compliance-scoring.md`
...
**Kimi invoke:** `/skill:compliance-audit` (not `/compliance-audit`).
