...
1. Read command spec: `../gtcx-docs/03-platform/tools/audit/audit-framework/commands/docs-machine-readable.md`
2. Read prompt (BEGIN PROMPT → END PROMPT): `../gtcx-docs/03-platform/tools/audit/audit-framework/prompts/01-docs/forensic-docs-machine-readable-prompt.md`
