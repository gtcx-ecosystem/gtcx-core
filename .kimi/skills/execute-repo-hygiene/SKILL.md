...
1. Read command spec: `../gtcx-docs/tools/audit/audit-framework/commands/execute-repo-hygiene.md`
2. Read prompt (BEGIN PROMPT → END PROMPT): `../gtcx-docs/tools/audit/audit-framework/prompts/hygiene/repo-hygiene-remediation-prompt.md`
