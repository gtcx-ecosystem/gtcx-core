...
1. Read command spec: `../gtcx-docs/03-platform/tools/audit/audit-framework/commands/gtm-audit.md`
2. Read prompt (BEGIN PROMPT → END PROMPT): `../gtcx-docs/03-platform/tools/audit/audit-framework/prompts/audit/forensic-gtm-audit-prompt.md`
3. Read scoring protocol: `../gtcx-docs/03-platform/tools/audit/lane-scoring/gtm-scoring.md`
