...
1. Read command spec: `../gtcx-docs/03-platform/tools/audit/audit-framework/commands/external-audit.md`
2. Read prompt (BEGIN PROMPT → END PROMPT): `../gtcx-docs/03-platform/tools/audit/audit-framework/prompts/lanes/external-audit-prompt.md`
3. Read scoring protocol: `../gtcx-docs/03-platform/tools/audit/lane-scoring/external-scoring.md`
4. **Protocol 27:** Run verification gates in-session; report command + exit code
5. Write forensic: `01-docs/05-audit/external-audit-YYYY-MM-DD.md` (today's date)
