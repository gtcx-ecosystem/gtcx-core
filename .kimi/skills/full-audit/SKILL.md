---
name: full-audit
description: GTCX audit alias: full-audit (same as engineering-audit) — GTCX lane-1 audit (lane 1; 1–3 hours)
---

# full-audit

**Alias for `engineering-audit`.** Same workflow as `/skill:engineering-audit`.

# full-audit (via engineering-audit)

Run the GTCX **engineering-audit** audit in **this repo** (`gtcx-core`).

## Steps

1. Read command spec: `../gtcx-docs/tools/audit/audit-framework/commands/engineering-audit.md`
