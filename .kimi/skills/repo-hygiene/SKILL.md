...
1. Read command spec: `../gtcx-docs/03-platform/tools/audit/audit-framework/commands/repo-hygiene.md`
2. Read prompt (BEGIN PROMPT → END PROMPT): `../gtcx-docs/03-platform/tools/audit/audit-framework/prompts/hygiene/repo-hygiene-protocol-prompt.md`
