...
Run the GTCX **repo-hygiene** audit in **this repo** (`gtcx-core`).

## Steps

1. Read command spec: `../gtcx-docs/tools/audit/audit-framework/commands/repo-hygiene.md`
2. Read prompt (BEGIN PROMPT → END PROMPT): `../gtcx-docs/tools/audit/audit-framework/prompts/hygiene/repo-hygiene-protocol-prompt.md`
3. Follow scoring in command + prompt
4. **Protocol 27:** Run verification gates in-session; report command + exit code
5. Write forensic: `docs/audit/repo-hygiene-YYYY-MM-DD.md` (today's date)
...
**Kimi invoke:** `/skill:repo-hygiene` (not `/repo-hygiene`).
