import type { CommodityType, LotOrigin, LotSpecifications, LotStatus, CustodyChain } from '../protocols/vaultmark';
...
export type CertificationType = 'origin' | 'assay' | 'conflict_free' | 'environmental' | 'labor' | 'export' | 'import' | 'custom';
