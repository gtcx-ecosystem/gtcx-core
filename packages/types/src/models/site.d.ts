...
export type SiteType = 'artisanal_mine' | 'small_scale_mine' | 'large_scale_mine' | 'collection_point' | 'buying_center' | 'processing_facility' | 'refinery' | 'vault' | 'port';
...
export type SiteStatus = 'pending_registration' | 'registered' | 'active' | 'suspended' | 'inactive' | 'closed';
