...
export type OrderStatus = 'draft' | 'pending' | 'active' | 'matched' | 'settling' | 'settled' | 'cancelled' | 'expired' | 'disputed';
/**
...
export type SettlementStatus = 'initiated' | 'payment_pending' | 'payment_received' | 'asset_pending' | 'asset_transferred' | 'completed' | 'failed' | 'rolled_back';
...
export type PaymentMethod = 'bank_transfer' | 'mobile_money' | 'escrow' | 'letter_of_credit' | 'crypto';
...
export type EscrowStatus = 'created' | 'funded' | 'locked' | 'releasing' | 'released' | 'disputed' | 'refunded';
