 ...
 */
export type CommodityType = 'gold' | 'silver' | 'platinum' | 'palladium' | 'copper' | 'cobalt' | 'lithium' | 'tantalum' | 'tungsten' | 'tin' | 'cocoa' | 'coffee' | 'cotton' | 'other';
/**
...
export type GeoTagProofType = 'location' | 'photo' | 'document' | 'workflow' | 'custody' | 'transfer';
...
export type PhotoCategory = 'site' | 'production' | 'equipment' | 'sample' | 'transport' | 'storage' | 'documentation';
/**
 ...
 */
export declare function migrateGeologicalContext(geo: GeologicalContext, commodityType?: CommodityType): ResourceContext;
/**
 * Helper to create ResourceContext for any commodity
 */
export declare function createResourceContext(commodityType: CommodityType, potential: 'high' | 'medium' | 'low' | 'none', confidence: number, options?: {
    formation?: string;
    source?: string;
}): ResourceContext;
//# sourceMappingURL=geotag.d.ts.map