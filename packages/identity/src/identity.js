 ...
 */
export function generateIdentityId(prefix = 'GTCX') {
 ...
 */
export async function createEnhancedIdentity(options = {}) {
...
export function validateIdentity(identity) {
    ...
    if (!identity.privateKeyRef)
        errors.push('Missing private key reference');
 ...
 */
export function isIdentityExpired(identity) {
 ...
 */
export async function deriveIdentity(parentIdentity, context, options = {}) {
