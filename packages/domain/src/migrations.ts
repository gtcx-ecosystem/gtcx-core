...
export class SchemaMigrator {
   ...
   */
  wrap<T>(data: T, entityType: EntityType, version?: string): VersionedEntity<T> {
    return {
      data,
 ...
 */
export function migrateAndUnwrap<T>(data: T | VersionedEntity<T>, entityType: EntityType): T {
