...
- [`docs/architecture/overview.md`](../architecture/overview.md) — layer map and trust boundaries
- [`docs/decisions/`](../decisions/) — all ADRs
- [`docs/security/security-framework.md`](../security/security-framework.md) — security framework
- [`docs/specs/packages/`](./packages/) — per-package specifications
- [`docs/devops/runbooks/quality-runbook.md`](../devops/runbooks/quality-runbook.md) — quality gates
