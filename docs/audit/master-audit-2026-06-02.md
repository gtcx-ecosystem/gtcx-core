...
1. Fix missing `vi` import in `packages/network/tests/network.test.ts:175,186` — test regression since last audit
2. Remove or populate empty test suite `tools/npm-provenance-utils.test.mjs` — ghost artifact
...
- Fix missing `vi` import in `packages/network/tests/network.test.ts:175,186`
- Remove or populate `tools/npm-provenance-utils.test.mjs`
...
| -------- | ------------------------------------------------------------------------------------------ | ------------------------ | --------------------------- | --------- | ----------------------- |
| P1       | Fix `vi` import regression in `packages/network/tests/network.test.ts`                     | developer                | None                        | 1 day     | +0.1 Code Quality       |
...
| 6. Master        | —      | docs(audit): master forensic certification per gtcx-ecosystem/tools/audit-framework/forensic-master-prompt.md |
