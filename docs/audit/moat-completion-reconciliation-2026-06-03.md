...
| ------------------------------------ | --------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------- |
| **A — Internal engineering 10/10**   | Docs, CI, ai-eval scorecard, 21-package provenance, DevEx | [execution-roadmap.md](./execution-roadmap.md), [gtm-roadmap-10-10-internal](../gtm/gtm-roadmap-10-10-internal-2026-06-01.md)    | **Sprints 1–4 done**; Sprint 5 blocked (ai-eval npm)                                               |
