...
| --------------------------------------------------------- | -------- | ------------------------------- |
| `docs/gtm/gtm-reality-check-2026-06-02.md`                | Yes      | Defensibility Tier 1–5 table    |
| `docs/audit/moat-completion-reconciliation-2026-06-03.md` | Yes      | § strategic moat; §6 Tier 5 row |
| `docs/audit/master-audit-2026-06-03.md`                   | Yes      | §1.6 DTF-001                    |
...
**Finding DTF-C1 (Medium):** Prior audits remain discoverable via `docs/audit/` without pointing to DTF-001; risk of agents citing stale moat claims.
...
| File                                         | Issue                               | Severity                    |
| -------------------------------------------- | ----------------------------------- | --------------------------- |
| `docs/specs/ai-evaluation-pipeline.md`       | “90-day copy test” for ai-eval moat | Medium — maps to **Tier 4** |
| `docs/specs/packages/jurisdiction-config.md` | No DTF link; Tier 5 packs implied   | Low                         |
| `docs/specs/packages/crypto.md`              | No DTF tier callout                 | Low                         |
...
| File                                                               | Issue                                                      | Severity                               |
| ------------------------------------------------------------------ | ---------------------------------------------------------- | -------------------------------------- |
| `docs/roadmap.md` §4.10                                            | “90-day copy test” for ai-eval                             | Medium                                 |
| `docs/agile/roadmap/algorithmic-moat-program-2026-06-02.md`        | Opening claims “copyable in 90 days” for algorithmic layer | **High** — contradicts Tier 2 achieved |
| `docs/audit/moat-completion-reconciliation-2026-06-03.md` §1 table | Track A still says “Sprint 5 blocked”                      | **High** — S5 done 2026-06-03          |
...
| `docs/overview/README.md` | No DTF pointer                         |
...
**File:** `gtcx-protocols/docs/gtm/sovereign-positioning.md` § “90-day copy test” — valid protocols narrative; optional footnote linking DTF for `gtcx-core` crypto depth.
...
| File                                               | Issue                                   |
| -------------------------------------------------- | --------------------------------------- |
| `docs/audit/prompts/forensic-full-audit-prompt.md` | Requires “90-day copy test” without DTF |
| `docs/audit/prompts/forensic-master-prompt.md`     | Same                                    |
...
| P2  | `AGENTS.md` + `docs/overview/README.md` DTF pointer                           | protocol-architect | 2 files                                        |
