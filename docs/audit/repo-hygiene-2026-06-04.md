...
| Path                                              | Present | Used           |
| ------------------------------------------------- | ------- | -------------- |
| `docs/operations/repo/repo-hygiene-protocol.md`   | Yes     | Primary policy |
| `docs/operations/repo/root-allowlist.json`        | Yes     | v1.0.0         |
| `scripts/ops/check-workspace-root-cleanliness.py` | Yes     | Strict checker |
...
| 2. Per-directory README | 10.0  | 0 missing README under `packages/*/` sweep                               |
...
| P1-5 | `packages/README.md` inventory | done (24 + 4 config) |
...
packages/*/ README sweep — 0 MISSING
packages/README.md — 24 runtime + 4 config (28 workspace entries)
```
...
| Per-directory README    | axis 2 | pass    | 100% `packages/*/` sweep                          |
...
| Inventory accuracy      | M3     | pass    | `packages/README.md` matches tree                 |
