...
- **[P1] `docs/security/pen-test-engagement-log.md`** — pen-test vendor not selected. _(outreach emails now drafted, vendor selection pending)_
...
- **[P2] `rust/gtcx-zkp/src/tests.rs:470`** — 470 LOC; approaching 500 LOC limit. **RESOLVED in this delta.**
...
| ------------------------------------------------- | ------------------------------------------------------------------ | ------------------- |
| `rust/gtcx-zkp/src/tests.rs` 470 LOC limit breach | Split into 7 focused test modules (bulletproofs, commitment, etc.) | `05b38e1`           |
...
| No internal readiness checklist                   | Created `docs/internal/external-readiness-checklist.md`            | `2fdfd9c`           |
...
| Pen-test vendor outreach  | Not started         | Drafted outreach emails with tracking tables in `docs/internal/`                | Security +0.0 (vendor not selected) |
