...
| CORE-004  | D3     | **Partial** — [verify JSON](./core-004-trusted-setup-verify-2026-06-04.json) · [status doc](../../operations/coordination/core-004-xr402-blocker-2026-06-04.md) · [transcript README](../../../artifacts/trusted-setup/README.md) | `cargo test -p gtcx-zkp --features trusted-setup-verify --release` exit 0; publish `transcript.seed` + KAT pin pending |
