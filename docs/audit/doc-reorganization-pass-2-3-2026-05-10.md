---
title: 'Documentation Reorganization Pass 2 + Pass 3 Audit — 2026-05-10'
status: 'current'
date: '2026-05-27'
owner: 'gtcx-core'
...
| ------------------------------------------------ | ----------------- | -------------------------------------------------------------------------------------------------------------- |
| `_delete/GEMINI.md`                              | `DELETE-DUPE`     | Repo standards are already covered by `CLAUDE.md`, `docs/testing/quality-standards.md`, and role/runbook docs. |
| `_delete/agentic-guide.md`                       | `DELETE-OBSOLETE` | Superseded by current `docs/agents/` structure and repo-specific onboarding content.                           |
...
| `_delete/uat-evidence-log-DUPLICATE.md`          | `DELETE-DUPE`     | Duplicate of canonical `docs/agile/testing/uat-evidence-log.md`.                                               |
...
| `_delete/remediation-plan-2026-05-06.md`         | `DELETE-OBSOLETE` | Superseded by current remediation docs under `docs/audit/`.                                                    |
| `_delete/10-10-roadmap-2026-05-06.md`            | `DELETE-OBSOLETE` | Superseded by current remediation docs under `docs/audit/` and `docs/gtm/`.                                    |
...
Cross-checked each substantive-looking file against the live `docs/` tree.

| Check                                           | Result |
| ----------------------------------------------- | ------ |
| Duplicate-content rescue needed                 | No     |
| Distinct canonical content missing from `docs/` | No     |
...
- duplicated elsewhere in canonical `docs/`,
