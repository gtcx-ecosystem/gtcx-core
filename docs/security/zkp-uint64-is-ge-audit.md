...
Function under audit: `uint64_is_ge` in `rust/gtcx-zkp/src/groth16/mod.rs` (lines 96–116).
...
- `rust/gtcx-zkp/src/groth16/mod.rs` lines 96–116
- `ark-r1cs-std` v0.4.0 `src/bits/uint.rs` line 82 (`to_bits_le` implementation)
- `docs/security/zkp-sidechannels.md` — threat model and attacker model
