...
- [Pen Test Scope](./pen-test-scope.md) — what the test must cover
- [Pen Test RFP 2026](./pen-test-rfp-2026.md) — vendor-facing RFP
- [Engagement Readiness Roadmap](../agile/roadmap/engagement-readiness-sprint-roadmap-2026-05-22.md) — Sprint 4 task 4.1
...
To be populated as outreach begins. Template:

| Vendor             | Outreach date | Response received | Quote range | Timeline | Status  | Notes |
| ------------------ | ------------- | ----------------- | ----------- | -------- | ------- | ----- |
| _Trail of Bits_    | —             | —                 | —           | —        | Pending | —     |
| _NCC Group_        | —             | —                 | —           | —        | Pending | —     |
| _Cure53_           | —             | —                 | —           | —        | Pending | —     |
| _Doyensec_         | —             | —                 | —           | —        | Pending | —     |
| _Atredis Partners_ | —             | —                 | —           | —        | Pending | —     |
