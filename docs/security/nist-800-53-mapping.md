...
| SC-13   | Cryptographic Protection                       | SHA-256 (FIPS 180-4), Secp256k1 ECDSA (FIPS 186-4), Ed25519 (RFC 8032)     | See `docs/security/fips-assessment.md`                |
...
| SA-15   | Development Process, Standards, and Tools | 13 ADRs documenting all architectural decisions; 4 agent roles with safety rules | `docs/decisions/`, `docs/agents/roles/`                     |
...
- `docs/security/threat-control-matrix.md` — 12 threat controls
- `docs/security/fips-assessment.md` — FIPS compliance pathway
- `docs/security/security-framework.md` — Security architecture
