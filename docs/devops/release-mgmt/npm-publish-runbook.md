...
Once all packages are verified, update [`docs/governance/trust-portal.md`](../../governance/trust-portal.md) with a "Published versions" section listing each `@gtcx/*` package with its current npm version (Sprint 2 task 2.5).
