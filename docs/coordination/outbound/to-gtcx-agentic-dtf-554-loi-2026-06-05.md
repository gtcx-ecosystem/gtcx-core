...
1. Link register row **DTF-5.5.4** to packet [`dtf-554-loi-h554-packet-2026-06-05.md`](https://github.com/gtcx-ecosystem/gtcx-core/blob/main/docs/operations/coordination/dtf-554-loi-h554-packet-2026-06-05.md) (mirror in agentic archive optional).
...
**One-line ask:** Sign LOI or regulator letter per H-554 packet; Legal redacts; file witness row in `docs/audit/evidence/dtf-554-loi-witness-index.md`.

## Evidence (gtcx-core)

| Artifact           | Path                                                                         |
| ------------------ | ---------------------------------------------------------------------------- |
| H-554 packet       | `docs/operations/coordination/dtf-554-loi-h554-packet-2026-06-05.md`         |
| Commercial tracker | `docs/operations/coordination/dtf-554-commercial-gate-tracker-2026-06-07.md` |
| Witness index      | `docs/audit/evidence/dtf-554-loi-witness-index.md`                           |
| Pack manifest      | `docs/audit/evidence/certified-pack-manifest-latest.json`                    |
