...
2. Maintain the deprecated behavior for a minimum of **2 MINOR releases or 3 months** — whichever is longer
...
**EOL Notice**: Announce end-of-life dates at least **6 months** in advance via release notes and a migration guide posted to `gtcx-docs`. For packages consumed by mobile clients (`@gtcx/crypto`, `@gtcx/identity`), 12 months notice is required due to app store release cycles.
