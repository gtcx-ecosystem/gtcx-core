---
title: "ADR-007: Offline-First with Deterministic Conflict Resolution"
status: "current"
date: "2026-05-27"
owner: "gtcx-core"
...
---
title: '007 Offline First Architecture'
status: 'current'
date: '2026-05-17'
...
- Feature phone users interact via USSD (`*384#`) — their operations are server-side but designed to tolerate intermittent cellular connectivity
