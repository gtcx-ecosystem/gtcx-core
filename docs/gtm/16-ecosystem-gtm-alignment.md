...
**Canonical infrastructure GTM hub:** [gtcx-infrastructure/docs/gtm/README.md](https://github.com/gtcx-ecosystem/gtcx-infrastructure/blob/main/docs/gtm/README.md)

**Strategy to use for African central-bank sandboxes:** [Global South 10/10 Plan](https://github.com/gtcx-ecosystem/gtcx-infrastructure/blob/main/docs/gtm/plans/global-south-10x-plan.md) — not the $750K FFIEC bank-subsidiary plan unless pursuing US/EU Tier-1 bank.
...
| ----------------------------------------- | --------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------ |
| **Pen-test vendor + report**              | gtcx-infrastructure (scope) + GTM (signature)       | [`pentest-scope-rfp.md`](https://github.com/gtcx-ecosystem/gtcx-infrastructure/blob/main/docs/gtm/regulatory/pentest-scope-rfp.md), [`pen-test-intake-evidence-2026-05-31.md`](https://github.com/gtcx-ecosystem/gtcx-infrastructure/blob/main/docs/audit/pen-test-intake-evidence-2026-05-31.md) | **EXT-INF-002** (SOW pending; ordered **after** Sprint 1 per Q5)   |
| **SOC 2 Type I**                          | quality-evidence + infrastructure evidence pipeline | [`soc2-readiness-checklist.md`](https://github.com/gtcx-ecosystem/gtcx-infrastructure/blob/main/docs/gtm/regulatory/soc2-readiness-checklist.md)                                                                                                                                                  | Post-revenue / bank partnership; not on Global South critical path |
| **Zimbabwe pre-submission / ZWCMP pilot** | GTM + legal (infra evidence)                        | Core: [`sandbox-intro-email-template.md`](./sandbox-intro-email-template.md); Infra: [`sandbox-application/`](https://github.com/gtcx-ecosystem/gtcx-infrastructure/tree/main/docs/gtm/sandbox-application)                                                                                       | **EXT-INF-013** (pilot owner), **014** (DPA), **015** (SLA)        |
...
| STRIDE + threat matrix            | [`01-security-posture.md`](./01-security-posture.md), `docs/security/threat-control-matrix.md`                                   |
...
| Fuzz campaign                     | [`docs/audit/fuzz-campaign-evidence-2026-05-21.md`](../audit/fuzz-campaign-evidence-2026-05-21.md)                               |
...
2. **Scores:** Library internal 9.5/10 ≠ ecosystem certified 10/10. Use infrastructure **IR + XC** scoring for deployable product ([SCORING.md](https://github.com/gtcx-ecosystem/gtcx-infrastructure/blob/main/docs/audit/SCORING.md)).
