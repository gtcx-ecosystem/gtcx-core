...
- **Registry location:** `packages/workproof/src/predicates/registry.ts`
- **Schema validation:** Zod schemas in `packages/workproof/src/predicates/schemas.ts`
...
- [Cross-Repo Handoff](../../docs/agents/sessions/2026-05-25-handoff-gtcxcore-gtcxprotocols.md) — gtcx-protocols implementation guide
