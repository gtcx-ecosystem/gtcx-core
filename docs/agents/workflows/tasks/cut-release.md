...
- `docs/devops/release-mgmt/release-checklist.md` — authoritative gate list
- `docs/compliance/governance-and-evidence.md` — evidence requirements
- `docs/agile/testing/uat-evidence-log.md` — confirm UAT evidence exists for any new features
...
All tests pass. Coverage must meet the threshold in `docs/testing/quality-standards.md`.
...
5. Any UAT gaps (features without evidence in `docs/agile/testing/uat-evidence-log.md`)
...
Follow the publish procedure in `docs/devops/ci-cd/ci-cd.md`.

### Step 4 — Update UAT evidence log

If this release closes sprint UAT gates, update `docs/agile/testing/uat-evidence-log.md`.
...
- [ ] `docs/agile/testing/uat-evidence-log.md` updated for completed sprints
