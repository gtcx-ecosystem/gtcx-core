...
`docs/agents/` connects to `1-agentic`. Governance is defined and operational; technical wiring is planned. See [`onboarding/agentic-integration.md`](onboarding/agentic-integration.md) for current state.
