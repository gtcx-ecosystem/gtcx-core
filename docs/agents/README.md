...
`docs/agents/` connects to `1-agentic`. Governance is defined and operational; technical wiring is planned. See [`1-onboarding/1-agentic-integration.md`](1-onboarding/1-agentic-integration.md) for current state.
