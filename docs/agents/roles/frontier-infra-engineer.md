...
2. Read package specs in `docs/specs/packages/` for `@gtcx/sync`, `@gtcx/network`, `@gtcx/crypto-native`
3. Read `docs/architecture/overview.md` — network and sync layer boundaries
