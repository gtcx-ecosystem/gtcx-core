...
| Date       | From      | To             | Scope                                            | File                                                                                | Status |
| ---------- | --------- | -------------- | ------------------------------------------------ | ----------------------------------------------------------------------------------- | ------ |
| 2026-06-03 | gtcx-core | ecosystem      | Coordination folder + bridge + sprint workplan   | `docs/operations/coordination/`                                                     | Open   |
| 2026-06-03 | gtcx-core | gtcx-protocols | `@gtcx/zkp-kat-vectors` consumption tracking     | `docs/operations/coordination/remaining-cross-repo-work-2026-06-02.md`              | Open   |
| 2026-06-03 | gtcx-core | gtcx-infra     | **EAP bundle sync DONE** — ESO refresh requested | `docs/operations/coordination/to-gtcx-infrastructure-eap-eso-refresh-2026-06-03.md` | Done   |
| 2026-06-03 | gtcx-core | baseline-os    | External vendor + Zimbabwe email tracking        | `docs/operations/coordination/remaining-cross-repo-work-2026-06-02.md`              | Open   |
