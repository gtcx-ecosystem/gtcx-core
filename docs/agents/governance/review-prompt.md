...
**Owner:** `docs/agents/roles/crypto-security-engineer.md`
...
docs/agents/governance/review-schema.json. No prose outside
...
- docs/decisions/{relevant_adrs}

Emit a single JSON document conforming to
docs/agents/governance/review-schema.json. Nothing else.
```
...
| ------------------------------------------------------------------------------------ | ---------------- |
| `packages/crypto/`, `packages/crypto-native/`, `rust/gtcx-crypto/`, `rust/gtcx-zkp/` | `crypto`         |
