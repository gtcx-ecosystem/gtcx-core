...
| Evidence path  | `docs/audit/evidence/` — filename pattern `dtf-554-loi-YYYY-MM-DD-redacted.pdf` (or `.md` witness index pointing to vault) |
...
**Ecosystem register:** [`human-external-blocker-register-2026-06.md`](https://github.com/gtcx-ecosystem/gtcx-agentic/blob/main/docs/operations/coordination/human-external-blocker-register-2026-06.md) — row **DTF-5.5.4** `awaiting-human`
...
1. Redacted LOI/letter in `docs/audit/evidence/` with frontmatter witness row
