...
| Artifact              | Location                                                                                                                                                                                    |
| --------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Infra inbound receipt | [`from-gtcx-core-er-1-08-hub-ack-2026-06-03.md`](https://github.com/gtcx-ecosystem/gtcx-infrastructure/blob/main/docs/operations/coordination/from-gtcx-core-er-1-08-hub-ack-2026-06-03.md) |
| Hub log row           | [`cross-repo-agent-log.md`](https://github.com/gtcx-ecosystem/gtcx-infrastructure/blob/main/docs/operations/coordination/cross-repo-agent-log.md) — `2026-06-04T23:50Z` ER-1-08 done        |
| Protocols outbound    | [`to-gtcx-protocols-er-1-08-infra-ack.md`](https://github.com/gtcx-ecosystem/gtcx-infrastructure/blob/main/docs/operations/coordination/to-gtcx-protocols-er-1-08-infra-ack.md)             |
| Commit                | `f8e1425`                                                                                                                                                                                   |
