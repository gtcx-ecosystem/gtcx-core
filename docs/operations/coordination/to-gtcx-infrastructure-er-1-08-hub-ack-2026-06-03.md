...
| Issuance evidence  | `docs/audit/evidence/eap-issuance-2026-06-03-*`                                                                |
...
3. Mirror ack path: `docs/operations/coordination/from-gtcx-infrastructure-er-1-08-hub-ack-YYYY-MM-DD.md` (or link to infra repo equivalent).
