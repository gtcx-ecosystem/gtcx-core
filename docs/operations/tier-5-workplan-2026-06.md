...
|    **5 technical** | **In progress** — next automatable work **DTF-5.1.3** |
...
| DTF-5.1.3 | NAPI prove/verify (profile-aware, same R1CS)                          | S-T5-1 | frontier-infra-engineer    | pending  | code             | 5.1.2       | 5.1.4             |
