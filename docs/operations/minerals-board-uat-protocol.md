...
**Completed run naming:** `docs/audit/evidence/minerals-board-uat-YYYY-MM-DD.json`
...
- [x] Protocol document published (`docs/operations/minerals-board-uat-protocol.md`)
- [x] JSON evidence template published (`docs/audit/evidence/minerals-board-uat-evidence-template.json`)
...
| ZKP circuit profiles | [zkp-circuit-profiles.md](../specs/packages/zkp-circuit-profiles.md)                              |
