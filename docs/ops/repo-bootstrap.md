...
| `anthropic-api-key`                  | ANTHROPIC_API_KEY repo secret is set                         | gh secret set ANTHROPIC_API_KEY --repo gtcx-ecosystem/gtcx-core<br>UI: https://github.com/gtcx-ecosystem/gtcx-core/settings/secrets/actions                                                                                                                                                                          |
