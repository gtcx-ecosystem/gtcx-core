...
Authoring standard for all documentation under `docs/`.
...
- Product strategy, pricing, or market docs → `docs/1-product/` (N/A for this repo)
- Devops runbooks, CI/CD, environments → `docs/devops/`
- Package-level specs → `docs/5-specs/`
- Sprint plans, backlogs, retrospectives → `docs/agile/`
