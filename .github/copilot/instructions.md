...
- **Security-sensitive paths:** `03-platform/packages/crypto/`, `rust/gtcx-crypto/`, `rust/gtcx-zkp/` require extra care
...
- **"What does this repo do?"** → Reference `01-docs/overview/README.md` §1-2
- **"Is this secure?"** → Reference `01-docs/09-security/threat-control-matrix.md`
- **"What's the repo score / readiness?"** → `01-docs/01-agents/readiness-and-audit-lanes.md` + `01-docs/05-audit/latest.json` (8.9 is bank-grade lane 4 only)
- **"How do I add a package?"** → Reference `01-docs/01-agents/workflows/tasks/add-package.md`
