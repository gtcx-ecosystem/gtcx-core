...
- `agent-workflow-patterns.md` - Common workflows and patterns for agents
...
2. Read agent-behavioral-config.md   # Understand expected behavior
3. Read agent-usage-guide.md        # Learn the system
4. Bookmark agent-quick-commands.md # Keep for reference
```
...
2. Review agent-workflow-patterns.md # Find relevant pattern
3. Use agent-communication-templates.md # For updates
```
...
- Check agent-safety-rules.md before major changes
- Use agent-checklist.md for validation
```
