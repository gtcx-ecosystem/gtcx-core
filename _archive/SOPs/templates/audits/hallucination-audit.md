...
If multiple Ralph agents (hats) contributed to the audited content, accuracy is broken down by agent.
...
_Audit conducted under the GTCX Quality Framework. Next review scheduled: {next-review-date}_
