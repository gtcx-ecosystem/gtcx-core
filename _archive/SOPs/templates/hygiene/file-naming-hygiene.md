...
Consistent, predictable file naming across all {organization} repositories. When every file follows the same naming conventions, developers can find files by intuition rather than searching, and tooling (linters, bundlers, scripts) works reliably across the ecosystem.
...
- [ ] Config files follow {organization} ecosystem standard
