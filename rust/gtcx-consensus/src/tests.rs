...
fn test_government_has_highest_weight() {
    assert!(StakeholderType::Government.default_weight() > StakeholderType::Vault.default_weight());
    assert!(StakeholderType::Vault.default_weight() > StakeholderType::Industry.default_weight());
    assert!(
        StakeholderType::Industry.default_weight() > StakeholderType::Technical.default_weight()
    );
}
