...
Keeping {organization} repositories clean, secure, and maintainable. A well-maintained repository reduces onboarding friction, prevents security incidents, and ensures consistent quality across the ecosystem.
...
- [ ] `docs/` folder follows {organization} documentation standard
