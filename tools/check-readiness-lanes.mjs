...
const latest = readJson('docs/audit/latest.json');
if (latest) {
...
const forbiddenPath = join(root, 'docs/audit/external-dependent-compliance-2026-06-05.md');
if (existsSync(forbiddenPath)) {
  failures.push('Remove deprecated docs/audit/external-dependent-compliance-2026-06-05.md');
}

// Hub files that must not use deprecated lane language (guide doc lists deprecated terms intentionally).
const hubFiles = ['README.md', 'docs/README.md', 'docs/audit/README.md', 'docs/overview/README.md'];
