 ...
 *
 * Reads docs/security/threat-control-matrix.md, parses the Control Register,
 * and validates:
 ...
 *      corresponding remediation item in docs/remediation/REMEDIATION_PLAN.md.
 *
...
const MATRIX_PATH = 'docs/security/threat-control-matrix.md';
const REMEDIATION_PATH = 'docs/remediation/REMEDIATION_PLAN.md';
...
/**
 * Check whether docs/remediation/REMEDIATION_PLAN.md contains a reference to
