...
> **Action plan:** `01-docs/internal/external-blocker-action-plan.md` — hard deadlines, daily actions, escalation paths, and contingency plans for every blocker.
...
| --- | ------------------------------------ | ------------------------ | ---------- | ---------- | ------------------------------------------------ |
| 1.1 | Select pen-test vendor from longlist | crypto-security-engineer | RFP ready  | 2026-06-16 | `01-docs/09-security/pen-test-engagement-log.md` |
| 1.2 | Confirm pen-test budget envelope     | Quality & Evidence Lead  | Approved   | 2026-05-25 | `01-docs/09-security/pen-test-rfp-2026.md`       |
| 1.3 | Select CPA firm for SOC 2 Type 1     | Quality & Evidence Lead  | Prep ready | 2026-06-09 | `01-docs/10-compliance/soc2-engagement-log.md`   |
| 1.4 | Confirm SOC 2 budget envelope        | Quality & Evidence Lead  | Approved   | 2026-05-29 | `01-docs/10-compliance/soc2-readiness-prep.md`   |
...
| 2.3 | Conduct first DR runbook drill (Scenario A)            | Protocol Architect      | Not scheduled | 2026-06-30 | `01-docs/devops/runbooks/dr-runbook.md`                                   |
| 2.4 | Refactor `gtcx-zkp/03-platform/src/tests.rs` (470 LOC) | frontier-infra-engineer | Pending       | 2026-06-15 | `rust/gtcx-zkp/03-platform/src/tests.rs`                                  |
| 2.5 | Send Zimbabwe pre-submission email                     | gtm-lead                | Draft ready   | 2026-05-30 | `01-docs/08-gtm/09-pre-submission-email-zimbabwe.md`                      |
| 2.6 | ADR-012 Stage 1 — gtcx-protocols implementation        | protocol-architect      | Handoff sent  | 2026-06-15 | `01-docs/01-agents/sessions/2026-05-25-handoff-gtcxcore-gtcxprotocols.md` |
