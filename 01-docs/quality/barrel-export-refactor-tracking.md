---
title: 'Barrel Export (`export *`) Refactor Tracking'
status: 'current'
date: '2026-05-27'
owner: 'gtcx-core'
...
| ------------------ | -------------------------- | ------------ | ----------------------------------------------------------------- |
| `@gtcx/api-client` | `03-platform/src/index.ts` | 3            | `export { TypeA, TypeB, TypeC } from './types'` etc.              |
| `@gtcx/network`    | `03-platform/src/index.ts` | 4            | `export { PeerDiscovery, PeerInfo } from './peer-discovery'` etc. |
| `@gtcx/schemas`    | `03-platform/src/index.ts` | 2            | `export { CoreSchema, ProvenanceSchema }` etc.                    |
| `@gtcx/sync`       | `03-platform/src/index.ts` | 1            | `export { SyncState, SyncConfig } from './types'`                 |
| `@gtcx/types`      | `03-platform/src/index.ts` | 4            | `export { ProtocolDef, ModelDef, ApiDef, CommonType }` etc.       |
