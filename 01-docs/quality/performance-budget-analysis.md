...
**Recommendation:** Update [`01-docs/08-gtm/03-fips-readiness.md`](../../01-docs/08-gtm/03-fips-readiness.md) to recommend BLAKE3 as the default hash for non-FIPS deployments, with SHA-256 as the FIPS-mandated fallback.
...
**Action required:** Add benchmark target to `03-platform/packages/compliance/` or `03-platform/packages/services/` test suite.
