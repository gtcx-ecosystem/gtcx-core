...
| Global-south fit     | In progress | Offline-first package design and docs under `01-docs/release/` and `01-docs/` |
...
| NEW-003 | Sprint S46 tracking skeleton is empty                                     | P2       | Fixed — `01-docs/05-audit/agile/sprints/current.md` populated |
| NEW-004 | `01-docs/remediation/remediation-plan.md` is draft-only                   | P2       | Open — scheduled S48                                          |
| NEW-005 | No `npm audit signatures` in CI                                           | P2       | Open — scheduled S47                                          |

## Operating Rule

Do not mark this tracker `10/10` until `01-docs/release/ga-release/ga-release-evidence-summary.md` shows evidence for all release gates and the blockers in `01-docs/release/ga-release/ga-release-status.md` are closed or formally accepted.
