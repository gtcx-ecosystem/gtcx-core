...
| Metric                    | Value                                                                                    |
| ------------------------- | ---------------------------------------------------------------------------------------- |
| TypeScript packages       | 22 public on npm + 4 config workspace + `@gtcx/ai-eval` (workspace tooling, not on npm)  |
| Rust crates               | 6                                                                                        |
...
| SLSA provenance           | Build L3 aspirational, Source L2 enforced; 21/22 packages on npm; attestations follow-up |
...
| ----------------------- | ---------------- | -------------------------------------------------------------------------------- |
| Model cards             | 6 published      | `01-docs/governance/model-cards/`                                                |
...
| Safety rules            | Machine-readable | `01-docs/01-agents/safety-rules.json`                                            |
...
**Engineering spec:** `01-docs/specs/ai-evaluation-pipeline.md`
...
| Model selection heuristic      | Recommend model per task type                  | Decision tree published in `01-docs/01-agents/model-selection.md` | 📋 Planned                                         |
...
| Cross-agent handoff         | Formal handoff protocol with evidence preservation   | `01-docs/01-agents/sessions/` auto-populated   | 📋 Planned |
...
**Engineering spec:** [`01-docs/specs/ai-evaluation-pipeline.md`](./specs/ai-evaluation-pipeline.md)  
**Synthesis source:** [`01-docs/05-audit/full-audit-2026-06-01.md`](./audit/full-audit-2026-06-01.md) — executive summary, Sprint 6
...
| 7-8   | Cross-repo publish automation (downstream PR opener)     | **In Progress** — spec: `01-docs/specs/cross-repo-publish-automation.md`    |
...
- [`01-docs/05-audit/execution-roadmap.md`](./audit/execution-roadmap.md) — **Active** sprint program (FA-S1–S6, DTF Tier 5)
- [`01-docs/05-audit/full-audit-2026-06-04.md`](./audit/full-audit-2026-06-04.md) — Latest 6-phase audit + sprint plan
- [`01-docs/04-ops/tier-5-workplan-2026-06.md`](./operations/tier-5-workplan-2026-06.md) — DTF-5.x register
- [`01-docs/05-audit/moat-completion-reconciliation-2026-06-03.md`](./audit/moat-completion-reconciliation-2026-06-03.md) — Unified 10/10 + moat + Tier 5 index
- [`01-docs/05-audit/agile/roadmap/roadmap.md`](./agile/roadmap/roadmap.md) — Delivery phases 0-7
- [`01-docs/05-audit/10-10-roadmap-2026-05-25.md`](./audit/10-10-roadmap-2026-05-25.md) — 10/10 reference-grade roadmap (honest baseline)
- [`01-docs/05-audit/master-audit-2026-05-25.md`](./audit/master-audit-2026-05-25.md) — Master audit and bank-grade certification
- [`01-docs/05-audit/internal-completion-audit-2026-05-21.md`](./audit/internal-completion-audit-2026-05-21.md) — Internal completion audit
- [`01-docs/architecture/backend-architecture.md`](./architecture/backend-architecture.md) — Full architecture doc
- [`01-docs/architecture/trust-contract-matrix.md`](./architecture/trust-contract-matrix.md) — Trust-bearing APIs
- [`01-docs/governance/model-cards/index.md`](./governance/model-cards/index.md) — AI model cards
