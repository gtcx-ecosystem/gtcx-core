...
sources:
  ...
  - 01-docs/05-audit/moat-dimension-roadmap-10-10.md
  - 01-docs/05-audit/execution-roadmap.md
  - 01-docs/05-audit/10-10-roadmap-2026-05-25.md
  - 01-docs/08-gtm/gtm-roadmap-10-10-internal-2026-06-01.md
...
| D4  | Backward compat      | **10**  | Done                              | `03-platform/packages/crypto/tests/zkp-*.test.ts`                                                                    |
...
| D7  | Side-channel         | **9**   | Internal done                     | `01-docs/09-security/zkp-sidechannels.md`, uint64 audit, dudect in CI; **M7.5 external lab**                         |
