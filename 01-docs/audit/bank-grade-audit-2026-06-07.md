...
> **Methodology:** [bank-grade-scoring.md](https://github.com/gtcx-ecosystem/gtcx-docs/blob/main/03-platform/tools/audit/lane-scoring/bank-grade-scoring.md) + [SCORING_FRAMEWORK.md](https://github.com/gtcx-ecosystem/gtcx-docs/blob/main/03-platform/tools/audit/audit-framework/SCORING_FRAMEWORK.md)  
...
- [x] Forensic: `01-docs/05-audit/bank-grade-audit-2026-06-07.md` (this file)
- [x] Lane index: update [bank-grade-2026-06-05.md](./bank-grade-2026-06-05.md) canonical row
- [x] `01-docs/05-audit/latest.json` → `lanes.bankGrade` + `legacy.sourceAudit`
