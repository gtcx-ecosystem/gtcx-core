...
- `rust/gtcx-crypto/03-platform/src/provider/aws_lc.rs` implements FIPS-validated Ed25519, SHA-256, SHA-512 via aws-lc-rs (CMVP #4816).
...
| 2.5 SLO documentation   | DONE    | `01-docs/04-ops/slo-definitions.md` exists                 |
| 2.6 DR runbook          | DONE    | `01-docs/devops/runbooks/dr-runbook.md` exists             |
