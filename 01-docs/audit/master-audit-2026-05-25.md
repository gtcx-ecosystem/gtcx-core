...
1. **Select pen-test vendor** from 5-vendor longlist and execute kickoff — `01-docs/09-security/pen-test-engagement-log.md`
...
| P2       | Refactor `rust/gtcx-zkp/03-platform/src/tests.rs` approaching 500 LOC | frontier-infra-engineer  | None             | M3     | Code Quality +0.1   |
