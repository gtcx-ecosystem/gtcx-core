...
| `node ./03-platform/tools/check-ai-scorecard.mjs` | PASS                                                   |
...
| Publish path                       | `03-platform/tools/publish-packages-provenance.mjs` (`pnpm pack` + `npm publish --provenance`) |
...
| `gtcx-infrastructure` | `03-platform/tools/replay-protection` — `@gtcx/crypto` `^3.1.4`                                             | Lockfile @ 3.1.4                                                          |
