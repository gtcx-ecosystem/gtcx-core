...
- **Scope**: All `dependencies` (not `devDependencies`) in all 21 `03-platform/packages/*/package.json`
...
- **Validation**: `grep -r '"\^' 03-platform/packages/*/package.json | grep -v devDependencies` returns zero results
...
- **Scope**: `@gtcx/verification` type-definition files showing 0% coverage
  - `03-platform/src/types/definitions/certificates.ts`
  - `03-platform/src/types/definitions/claims.ts`
  - `03-platform/src/types/definitions/commodities.ts`
  - `03-platform/src/types/definitions/predicates.ts`
  - `03-platform/src/types/definitions/proofs.ts`
  - `03-platform/src/types/definitions/qr.ts`
  - `03-platform/src/types/definitions/templates.ts`
...
- **Target**: Bring `03-platform/packages/verification` branch coverage from 83.13% to ≥90%
...
- **Document**: `01-docs/09-security/threat-model.md`
...
- **Document**: `01-docs/09-security/key-ceremony.md`
- **Contents**:
...
- **Document**: `01-docs/09-security/attack-tree-signing.md`
...
- **Action**:
  1. Isolate all Ed25519, SHA-256, and AES operations inside `gtcx-crypto/03-platform/src/fips/`
...
- **Artifact**: `01-docs/09-security/fips-readiness-report.md` documenting module boundary, self-tests, and vendor engagement status
...
- **New crate**: `gtcx-crypto/03-platform/src/hsm/` (Rust) or `@gtcx/crypto/03-platform/src/hsm/` (TypeScript bridge)
- **Supported backends**:
  - AWS CloudHSM
  - Azure Dedicated HSM
...
- **Document**: `01-docs/10-compliance/gdpr-data-flow.md`
- **Contents**:
...
- **Document**: `01-docs/10-compliance/pci-dss-scope.md`
...
- **Document**: `01-docs/10-compliance/sox-controls.md`
- **Contents**:
...
- **Document**: `01-docs/10-compliance/audit-readiness-checklist.md`
...
- **Action**: Generate `quality/audit-evidence-bundle/` containing:
  ...
  - Key ceremony (`01-docs/09-security/key-ceremony.md`)
  - Compliance docs (`01-docs/10-compliance/`)
  - ADRs (`01-docs/decisions/`)
  - Changesets (`.changeset/`)
- **Script**: `03-platform/scripts/generate-audit-bundle.sh` — reproducible, deterministic output

### F.2 Penetration Test Scope

- **Document**: `01-docs/09-security/pen-test-scope.md`
- **In-scope**:
...
| F     | Audit bundle                 | `03-platform/scripts/generate-audit-bundle.sh` produces deterministic output |
