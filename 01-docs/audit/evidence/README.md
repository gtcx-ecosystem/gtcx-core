...
**Canonical runtime smoke and deployment proofs** may also live in `gtcx-intelligence/01-docs/05-audit/evidence/` per [deployment-proof-index](https://github.com/gtcx-ecosystem/gtcx-protocols/blob/main/01-docs/05-audit/evidence/deployment-proof-index.md).
...
| DTF-5.4.1 | S-T5-4 | [`circuit-registry.manifest.json`](../../../03-platform/packages/crypto/circuit-registry.manifest.json)                                                                                                                                            | `pnpm test --filter @gtcx/crypto`                                                                                         |
...
| DTF-5.5.1 | S-T5-5 | Engagement jurisdiction packs under `03-platform/packages/domain/`                                                                                                                                                                                 | `pnpm jurisdiction:validate-packs`                                                                                        |
