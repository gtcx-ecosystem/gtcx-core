...
| ------------------- | ----------: | --------------: | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Structural          |  **9.4/10** |            +1.0 | Single canonical `/01-docs/` root. Root-level orphan `audit/` directory closed; empty `01-docs/05-audit/_historical/` removed (`91fc9f6`). Legacy taxonomy preserved per prior justification.           |
| Naming              | **10.0/10** |               — | All `01-docs/**/*.md` files kebab-case. ALL_CAPS audit filename renamed to `anti-inflation-audit-results-2026-05-11.md`. Root `.md` files all in standard allowlist (AGENTS, CLAUDE, etc).              |
| Frontmatter         | **10.0/10** |               — | `pnpm docs:check-frontmatter` — **222/222 files valid**, 42 excluded by pattern (`**/README.md`, templates, agent sessions). Schema enforced by `03-platform/tools/check-doc-frontmatter.mjs`.          |
...
| Master INDEX        |  **9.4/10** |               — | `01-docs/README.md` rewritten as canonical INDEX with audience-driven sections per `forensic-doc-cleanup-prompt.md`. Lookup-table model preserved.                                                      |
| **Overall**         |  **9.6/10** |            +0.5 |                                                                                                                                                                                                         |
...
| ------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------- |
| Root-level `audit/` directory holding 1 file outside `/01-docs/`                                 | `forensic-repo-hygiene-prompt.md` Axis 1 (root cleanliness) + single-doc-root rule     | `git mv audit/anti-inflation-audit-RESULTS-2026-05-11.md 01-docs/05-audit/anti-inflation-audit-results-2026-05-11.md`; directory removed; inbound links updated. | `91fc9f6` |
...
| Empty `01-docs/05-audit/_historical/` directory                                                  | `forensic-repo-hygiene-prompt.md` Axis 8 (empty/orphan dirs)                           | `rmdir 01-docs/05-audit/_historical/` — directory had no files (not even `.gitkeep`).                                                                            | `91fc9f6` |
...
| `01-docs/01-agents/sessions/index.md` does not follow `README.md` convention for directory indices                                   | Intentional design — file is referenced as `01-docs/01-agents/sessions/index.md` in agent session-handoff protocol; renaming would cascade-update agent instructions across the ecosystem. | Protocol Architect      | On-change    |
...
| ------------------------------------------ | --------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `forensic-doc-standard-prompt.md`          | Yes                   | `03-platform/tools/check-doc-frontmatter.mjs` + `03-platform/tools/check-markdown-links.mjs`; canonical `/01-docs/` tree manually audited each cycle.      |
| `forensic-doc-cleanup-prompt.md`           | Yes                   | Master INDEX in `01-docs/README.md`; no `_sop/`, `_cannon/`, `wiki/` competing roots; `01-docs/overview/README.md` retained as canonical bridge doc.       |
| `forensic-docs-machine-readable-prompt.md` | Yes                   | YAML frontmatter schema in `03-platform/tools/check-doc-frontmatter.mjs` mirrors `01-docs/01-agents/docs-standard-machine-readable.md`. Enforced 222/222.  |
...
| `forensic-full-audit-prompt.md`            | Yes                   | Latest applicable: [`01-docs/05-audit/internal-completion-audit-2026-05-21.md`](./internal-completion-audit-2026-05-21.md) (9.5/10 composite, 24/24 done). |
| `forensic-verification-audit-prompt.md`    | Yes                   | [`01-docs/05-audit/anti-inflation-audit-results-2026-05-11.md`](./anti-inflation-audit-results-2026-05-11.md) — anti-inflation forensic verification.      |
| `forensic-master-prompt.md`                | Yes                   | Master audit series: `01-docs/05-audit/master-audit-2026-05-{10,11,12}.md`; superseded by internal-completion-audit-2026-05-21 for current composite.      |
| `repo-overview-prompt.md`                  | Yes                   | [`01-docs/overview/README.md`](../overview/README.md) — 46 KB canonical bridge doc; status `current`, last updated 2026-05-17.                             |
| `10-10-roadmap-prompt.md`                  | Yes                   | Series: `01-docs/05-audit/10-10-roadmap-2026-05-{11,13,17,19}.md`; latest is 2026-05-19, reflecting M2+ at 9.5/10.                                         |
...
| GTM/marketing audit                                       | gtcx-core is a library; no end-user surface. GTM docs (`01-docs/08-gtm/`) target institutional partners and are reviewed under the standard frontmatter pass. |
