...
| ----- | ---------------- | ---------------------------------------- | ------------------------------------- |
| **A** | Repo engineering | Code, CI, docs hygiene, gates            | `01-docs/05-audit/latest.json` lane 1 |
...
1. Copy `.baseline/bout-progress.config.json` (see `01-docs/04-ops/03-platform/examples/`).
