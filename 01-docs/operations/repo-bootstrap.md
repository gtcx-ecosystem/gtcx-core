---
title: 'Repository Operational Prerequisites'
status: 'current'
date: '2026-05-27'
owner: 'gtcx-core'
...
Auto-generated from `03-platform/tools/check-ops-prereqs.mjs`. Do not edit by hand — modify the script and run `node 03-platform/tools/check-ops-prereqs.mjs --emit-doc`.
...
| `branch-protection-main`             | main branch protection is enabled                                           | UI: https://github.com/gtcx-ecosystem/gtcx-core/settings/branches<br>Required: code owner review, status checks (CI workflows), no force push, no deletion<br>CLI: gh api repos/gtcx-ecosystem/gtcx-core/branches/main/protection -X PUT --input - <<EOF<br>(see 01-docs/04-ops/repo-bootstrap.md for a templated payload) |
