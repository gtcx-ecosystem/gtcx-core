...
The trust portal and supporting documentation are published via GitBook sync from the `01-docs/` directory. GitBook rebuilds automatically when the synced source changes.

## What's already in the repo

| Artifact                             | Purpose                                         |
| ------------------------------------ | ----------------------------------------------- |
| `01-docs/gitbook/`                   | GitBook-structured external-facing product docs |
| `01-docs/governance/trust-portal.md` | Canonical external-facing evidence index        |
...
| Path                                                            | Should render                           |
| --------------------------------------------------------------- | --------------------------------------- |
| `/`                                                             | `01-docs/README.md` (master INDEX)      |
