...
| **Tier 5 — commercial** | DTF-5.5.4 or regulator letter (5-C2)                                                                                           | Redacted LOI/letter in `01-docs/05-audit/evidence/`                             |
...
| EXT-INF-002 | Live-stack pen-test        | gtcx-infrastructure | Pack ack filed; SOW signature Class S (infra)         | **outbound-acknowledged** |
...
**Cross-repo (S-T5-4 slice):** DTF-5.4.4 **done** — protocols [`73eaff2b`](https://github.com/gtcx-ecosystem/gtcx-protocols/commit/73eaff2b); inbound [`from-gtcx-core-dtf-5-4-4-inbound-2026-06-05.md`](https://github.com/gtcx-ecosystem/gtcx-protocols/blob/main/01-docs/04-ops/coordination/from-gtcx-core-dtf-5-4-4-inbound-2026-06-05.md); core ack [`to-gtcx-protocols-dtf-5-4-4-witness-ack-2026-06-05.md`](./coordination/to-gtcx-protocols-dtf-5-4-4-witness-ack-2026-06-05.md); intelligence witness-only [`5142ff8`](https://github.com/gtcx-ecosystem/gtcx-intelligence/commit/5142ff8) · [`from-gtcx-core-dtf-5-4-4-witness-2026-06-05.md`](https://github.com/gtcx-ecosystem/gtcx-intelligence/blob/main/01-docs/04-ops/coordination/from-gtcx-core-dtf-5-4-4-witness-2026-06-05.md). **P22** P22-EVID-03 still blocked ↔ INT-S9-01/OI-B08; protocols unchanged.
...
| Field          | Value                                                                                                               |
| -------------- | ------------------------------------------------------------------------------------------------------------------- |
| **Paths**      | `03-platform/packages/workproof/`, new `rust/gtcx-zkp/03-platform/src/witness/` (or equivalent)                     |
...
| Field          | Value                                                                                                    |
| -------------- | -------------------------------------------------------------------------------------------------------- |
| **Acceptance** | Prove/verify from TS via `@gtcx/crypto-native`; integration test in `03-platform/packages/crypto/tests/` |
