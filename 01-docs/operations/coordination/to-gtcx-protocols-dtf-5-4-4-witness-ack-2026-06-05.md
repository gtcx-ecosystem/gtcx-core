...
| Protocols inbound (owner repo) | [`from-gtcx-core-dtf-5-4-4-inbound-2026-06-05.md`](https://github.com/gtcx-ecosystem/gtcx-protocols/blob/main/01-docs/04-ops/coordination/from-gtcx-core-dtf-5-4-4-inbound-2026-06-05.md) |
| Protocols hub log row          | [`cross-repo-agent-log.md`](https://github.com/gtcx-ecosystem/gtcx-protocols/blob/main/01-docs/04-ops/coordination/cross-repo-agent-log.md) (2026-06-05T03:00Z)                           |
