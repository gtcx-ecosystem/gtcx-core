...
| Doc                        | Location                                                                  |
| -------------------------- | ------------------------------------------------------------------------- |
| Protocol 23                | `gtcx-docs/01-docs/governance/protocols/23-external-access-credentials/`  |
...
| ADR-001                    | `gtcx-docs/01-docs/architecture/adr/001-eap-control-plane-and-storage.md` |

## Phase B deliverables (EAP-02)

Package: **`03-platform/packages/eap`** (`@gtcx/eap`) — skeleton shipped:
