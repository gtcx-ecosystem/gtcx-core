---
title: 'Adoption Model — gtcx-core'
status: 'current'
date: '2026-05-27'
owner: 'gtcx-core'
...
graph TB
    ...
    subgraph Evaluation["Evaluation"]
        TRUST["Trust portal review<br/>(01-docs/governance/trust-portal.md)"]
...
graph LR
    subgraph Now["Pre-Sprint 2.3 (today)"]
        ...
        SYMLINK["pnpm symlink to<br/>03-platform/packages/crypto/dist"]
    end
...
graph TB
    ...
    PORTAL["Trust portal review<br/>(01-docs/governance/trust-portal.md)"]
