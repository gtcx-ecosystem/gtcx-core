...
| TypeScript Core Layer   | `03-platform/packages/*` — domain, crypto, identity, verification, sync, network | Depends on ↓ |
...
Enforced by: `pnpm architecture:check` via `03-platform/tools/check-package-boundaries.mjs`
