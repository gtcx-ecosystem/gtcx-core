---
title: 'Barrel Export Tracking — gtcx-core'
status: 'current'
date: '2026-05-27'
owner: 'gtcx-core'
...
Five packages use `export *` barrel patterns in their `03-platform/src/index.ts` entry points. This defeats tree-shaking in downstream bundlers (Webpack, Rollup, esbuild) and increases bundle size for consumers who only need a subset of exports.

## Affected Packages

| Package            | File                         | Export Count | Consumer Impact        | Target Resolution |
| ------------------ | ---------------------------- | ------------ | ---------------------- | ----------------- |
| `@gtcx/api-client` | `03-platform/src/index.ts:1` | ~15 exports  | All downstream bundles | Sprint S48        |
| `@gtcx/network`    | `03-platform/src/index.ts:1` | ~8 exports   | `gtcx-infrastructure`  | Sprint S49        |
| `@gtcx/schemas`    | `03-platform/src/index.ts:1` | ~25 exports  | All downstream bundles | Sprint S48        |
| `@gtcx/sync`       | `03-platform/src/index.ts:1` | ~10 exports  | Mobile clients         | Sprint S48        |
| `@gtcx/types`      | `03-platform/src/index.ts:1` | ~40 exports  | All downstream bundles | Sprint S49        |
...
_Tracked as HYG-002 in [`01-docs/05-audit/10-10-remediation-plan-2026-05-27.md`](../audit/10-10-remediation-plan-2026-05-27.md)._
