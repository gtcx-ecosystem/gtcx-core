...
Tier discipline is enforced: `pnpm architecture:check` (driven by [`03-platform/tools/check-package-boundaries.mjs`](../../03-platform/tools/check-package-boundaries.mjs)) blocks any PR that introduces a circular or upward dependency.
...
graph TB
    ...
    subgraph Boundary["Validation Boundary"]
        ASSERT["assertHex / isHex<br/>(03-platform/packages/crypto-native)"]
        ZOD["Zod schemas<br/>(03-platform/packages/schemas)"]
        SANITIZE["sanitizeSecrets<br/>(03-platform/packages/security)"]
    end
...
Cross-references: [`01-docs/09-security/threat-control-matrix.md`](../security/threat-control-matrix.md), [`01-docs/09-security/trust-contract-matrix.md`](./trust-contract-matrix.md), [`01-docs/09-security/fips-validation-boundary.md`](../security/fips-validation-boundary.md).
...
Operational detail in [`01-docs/devops/release-mgmt/npm-publish-runbook.md`](../devops/release-mgmt/npm-publish-runbook.md).
...
- [`01-docs/governance/trust-portal.md`](../governance/trust-portal.md) — external evidence index
