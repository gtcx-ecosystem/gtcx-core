...
| TS Property Testing          | `cd 03-platform/packages/crypto && pnpm test tests/property-based.test.ts`                         | PR merge |
...
- **Per release:** full gate sequence documented in `01-docs/devops/release-mgmt/release-checklist.md`
...
- [`01-docs/devops/runbooks/quality-runbook.md`](../devops/runbooks/quality-runbook.md) — gate sequence and triage order
- [`01-docs/devops/release-mgmt/release-checklist.md`](../devops/release-mgmt/release-checklist.md) — release checklist
- [`01-docs/decisions/011-architecture-boundary-enforcement.md`](../decisions/011-architecture-boundary-enforcement.md) — ADR-011
- [`01-docs/decisions/013-api-baseline-and-performance-budget-gates.md`](../decisions/013-api-baseline-and-performance-budget-gates.md) — ADR-013
