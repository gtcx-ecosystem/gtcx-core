---
title: 'GTCX Jurisdiction Configuration Schema'
status: 'current'
date: '2026-05-27'
owner: 'gtcx-core'
...
```typescript
// 03-platform/packages/config/jurisdiction/03-platform/src/schema.ts
...
```
03-platform/packages/config/jurisdiction/
├── 03-platform/src/
│   ├── index.ts
│   ├── schema.ts
│   ├── loader.ts
