...
Changes to `gtcx-crypto` and `gtcx-zkp` require Cryptographic Security Engineer review and human approval before merge. See `01-docs/01-agents/workflows/safety-rules.md`.
