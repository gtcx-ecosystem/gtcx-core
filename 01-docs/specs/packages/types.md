...
- [`01-docs/specs/core-spec.md`](../core-spec.md) — dependency rules; all packages may depend on `@gtcx/types`
- [`01-docs/devops/runbooks/quality-runbook.md`](../../devops/runbooks/quality-runbook.md) — API surface gate
