...
Per [Protocol 1 v2.0 §The Standard](https://github.com/gtcx-ecosystem/gtcx-docs/blob/main/system-sop/1-protocols/1-docs-structure/protocol.md), `01-docs/gitbook/` is the canonical home for _external-facing product docs_. For a foundation library with no end-user surface, there is no product to document at this layer.
...
| Trust / compliance content for external readers | [`01-docs/governance/trust-portal.md`](../governance/trust-portal.md) — the canonical external-facing evidence index.                                                                                                                                                        |
| Security disclosure flow                        | [`01-docs/09-security/vulnerability-disclosure.md`](../security/vulnerability-disclosure.md).                                                                                                                                                                                |
| Architecture for external readers               | [`01-docs/architecture/system-overview.md`](../architecture/system-overview.md), [`ecosystem-integration.md`](../architecture/ecosystem-integration.md), [`business-logic.md`](../architecture/business-logic.md), [`adoption-model.md`](../architecture/adoption-model.md). |
