...
4. **Refactor 6 Rust files >500 LOC** — start with `gtcx-node/03-platform/src/lib.rs` (970 lines)
...
| Threat model     | 9.0   | 12 STRIDE controls; validator passes (`03-platform/tools/check-threat-matrix.mjs`) |
...
| Sub-dimension        | Score | Evidence                                                             |
| -------------------- | ----- | -------------------------------------------------------------------- |
| Doc structure        | 9.5   | `/01-docs/` + `_delete/` only; new standards in `01-docs/01-agents/` |
...
No doc consolidation required. `/01-docs/` is the single canonical documentation root. `_delete/` contains 10 historical files awaiting archival.

New docs created since 2026-05-12:

| Document                    | Location                                              | Purpose                      |
| --------------------------- | ----------------------------------------------------- | ---------------------------- |
| Repo Overview               | `01-docs/overview/README.md`                          | Business + technical bridge  |
| Lightweight Standard        | `01-docs/01-agents/docs-standard-lightweight.md`      | Bundle budgets, barrel rules |
| Machine-Readable Standard   | `01-docs/01-agents/docs-standard-machine-readable.md` | YAML frontmatter spec        |
| Session Handoff Protocol    | `01-docs/01-agents/sessions/index.md`                 | Cross-agent handoffs         |
| Safety Rules                | `01-docs/01-agents/safety-rules.json`                 | 8 structured safety rules    |
| Routing Rules               | `01-docs/01-agents/routing-rules.json`                | 4 role routing rules         |
| Protocols Upstream Tracking | `01-docs/05-audit/gtcx-core-upstream-tracking.md`     | 7 capabilities to upstream   |
| 10/10 Roadmap               | `01-docs/05-audit/10-10-roadmap-2026-05-13.md`        | Updated milestone plan       |
...
| Axis                   | Score | Evidence                                        |
| ---------------------- | ----- | ----------------------------------------------- |
| Taxonomy compliance    | 9.5   | All docs in `/01-docs/<domain>/`                |
...
| Phase                   | Source                                         | Commit    |
| ----------------------- | ---------------------------------------------- | --------- |
| Master audit 2026-05-11 | `01-docs/05-audit/master-audit-2026-05-11.md`  | `0b47894` |
| Master audit 2026-05-12 | `01-docs/05-audit/master-audit-2026-05-12.md`  | `874405d` |
| M1 engineering          | `01-docs/05-audit/10-10-roadmap-2026-05-13.md` | `681b2aa` |
| M2 security hardening   | `01-docs/05-audit/10-10-roadmap-2026-05-13.md` | `0853e05` |
| Barrel refactoring      | `01-docs/05-audit/10-10-roadmap-2026-05-13.md` | `12fb184` |
| **This audit**          | `01-docs/05-audit/master-audit-2026-05-13.md`  | —         |
...
- [x] `node 03-platform/tools/check-threat-matrix.mjs` — 12 controls pass
...
_Based on: `01-docs/05-audit/master-audit-2026-05-12.md` §9 (honest scores)_
