...
**Action:** Open `01-docs/08-gtm/09-pre-submission-email-zimbabwe.md`, adapt, send to fintech@rbz.co.zw.

**Verification:** Log in `01-docs/08-gtm/responses/zimbabwe-2026-05-11.md`.
...
1. Close 7 documented gaps in `01-docs/10-compliance/soc2-readiness.md`
...
- Track all responses in `01-docs/08-gtm/responses/`
...
**Closed 2026-05-11.** `deployment/` collapsed into `devops/release-mgmt/publishing.md`; taxonomy rationale documented in `01-docs/README.md`; deprecated docs marked in index.
...
| GTM-001 | `01-docs/08-gtm/responses/zimbabwe-*.md` has "Sent" entry                 |
| EXT-001 | Pen-test report in `01-docs/09-security/external-pentest-2026.md`         |
| EXT-002 | SOC 2 letter in `quality/release-evidence/`                               |
| ARC-002 | `pnpm api:check` exits 0                                                  |
| DOC-001 | ~~`01-docs/README.md` documents retention rationale or dirs are gone~~ ✅ |
