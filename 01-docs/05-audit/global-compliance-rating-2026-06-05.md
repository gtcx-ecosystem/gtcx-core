...
**Primary command:** `global-compliance-audit` → `01-docs/05-audit/global-compliance-audit-<date>.md`  
**Scoring:** [global-compliance-scoring.md](https://github.com/gtcx-ecosystem/gtcx-docs/blob/main/03-platform/tools/audit/lane-scoring/global-compliance-scoring.md)  
