...
| 2026-05-06 | Documentation (Integration Guides) | `01-docs/specs/integration-guide.md`, `01-docs/specs/external-integration-guide.md`    | Pass: internal workspace and external consumer integration guides are both present                                         | Core Platform |
| 2026-05-02 | Documentation (AI Stub Caveats)    | README.md, 03-platform/packages/ai/README.md, 03-platform/packages/workproof/README.md | Pass: AI stub status explicitly documented in all READMEs                                                                  | Core Platform |
...
| 2026-06-01 | AI Evaluation Scorecard            | `artifacts/ai-scorecard.json`                                                          | Pass: `pnpm ai:evaluate` + `03-platform/tools/check-ai-scorecard.mjs`; CI uploads `ci-ai-scorecard` artifact               | Core Platform |
| 2026-06-01 | npm Provenance Verification        | `03-platform/tools/check-npm-provenance.mjs`                                           | Pass: tooling + release.yml verify; registry attestations on next `--provenance` publish                                   | Core Platform |
| 2026-06-01 | npm Provenance Registry (21/21)    | `pnpm provenance:check-npm:strict`                                                     | Pass: Sigstore at 3.1.4 train; release [26778909174](https://github.com/gtcx-ecosystem/gtcx-core/actions/runs/26778909174) | Core Platform |
| 2026-06-01 | Downstream npm provenance pinning  | `gtcx-protocols`, `gtcx-infrastructure` lockfiles                                      | Pass: only ecosystem npm consumers bumped to provenance baseline; GitBook supply-chain page synced                         | Core Platform |
