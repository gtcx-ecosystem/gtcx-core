...
2. For local evidence, record the command, date, commit SHA, and exact pass/fail outcome in `01-docs/release/ga-release/ga-release-evidence-log.md`.
3. Regenerate `01-docs/release/ga-release/ga-release-evidence-summary.md` after adding evidence.
