...
`01-docs/devops/` holds the engineering operations details that support this library repo: CI/CD, release management, monitoring, QA, and environment-specific guidance.
