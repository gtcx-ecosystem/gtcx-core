...
- System architecture (see `01-docs/architecture/`)
- Security architecture (see `01-docs/09-security/`)
- Technology stack decisions (see `01-docs/stack/`)
- Compliance standards (see `01-docs/10-compliance/`)
