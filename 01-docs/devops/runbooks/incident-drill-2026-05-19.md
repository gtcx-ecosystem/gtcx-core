...
cd 03-platform/packages/crypto
git diff v3.0.3..v3.0.4 -- 03-platform/src/
```

**Findings:**

- No direct changes to `03-platform/src/signing/ed25519.ts` between 3.0.3 and 3.0.4
...
1. **Security advisory** posted to `01-docs/09-security/advisories/2026-05-19-ed25519-canonicalization.md`
...
| --- | -------------------------------------------------------------------------------------------------------------------- | ------------------------ | ---------- | ------ |
| 1   | Pin all crypto dependencies to exact versions in `03-platform/packages/crypto/` and `03-platform/packages/security/` | crypto-security-engineer | 2026-05-20 | Done   |
...
| 5   | Update `01-docs/09-security/dependency-policy.md` to require exact-version pinning for all crypto dependencies       | protocol-architect       | 2026-05-23 | Open   |
