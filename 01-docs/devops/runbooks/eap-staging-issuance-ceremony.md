...
**Normative:** [Protocol 23 — External Access Credentials](https://github.com/gtcx-ecosystem/gtcx-docs/blob/main/01-docs/governance/protocols/23-external-access-credentials/protocol.md)
...
# 1) Issue + revoke + write evidence under gtcx-core/01-docs/05-audit/evidence/
...
#    See 01-docs/04-ops/coordination/to-gtcx-infrastructure-eap-eso-refresh-2026-06-03.md
```
...
Evidence glob for Protocols EAP-05: `gtcx-intelligence/01-docs/05-audit/evidence/eap-issuance-*.json` (canonical); gtcx-core copies under `01-docs/05-audit/evidence/` for issuance **ceremony** proof.
