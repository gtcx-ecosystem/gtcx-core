...
- `01-docs/devops/ci-cd/ci-cd.md` — full CI gate sequence
- `01-docs/10-compliance/compliance-requirements.md` — supply chain and SBOM requirements
