...
| Any change to `03-platform/tools/check-package-boundaries.mjs`                                                            | Architecture enforcement gate               |
...
- [`01-docs/01-agents/structure/coordination.md`](../structure/coordination.md) — decision matrix and coordination protocols
- [`01-docs/01-agents/workflows/tasks/`](./tasks/) — task playbooks for common operations
