---
title: 'Task Playbook: Expand a Public API'
status: 'current'
date: '2026-05-27'
owner: 'gtcx-core'
...
6. Record migration expectations in `01-docs/release/api-change-migration-policy.md` or the relevant package spec.
