...
ls 01-docs/decisions/ | sort
```

Read:

- `01-docs/decisions/README.md` — current index and numbering
- `01-docs/decisions/template.md` — mandatory template
...
Check the current highest number in `01-docs/decisions/README.md`. Use the next available number: `NNN`.

---

### 2. Create the ADR file

File path: `01-docs/decisions/NNN-<kebab-case-title>.md`

Use `01-docs/decisions/template.md` exactly. Fill every section:
...
Add the new ADR to `01-docs/decisions/README.md`:
...
- [ ] `01-docs/decisions/README.md` is updated
...
- [`01-docs/decisions/`](../../../decisions/) — ADR index and template
- [`01-docs/01-agents/roles/protocol-architect.md`](../../roles/protocol-architect.md) — Protocol Architect role
- [`01-docs/01-agents/roles/crypto-security-engineer.md`](../../roles/crypto-security-engineer.md) — required for crypto ADRs
