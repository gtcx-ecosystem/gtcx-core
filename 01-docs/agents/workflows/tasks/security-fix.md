---
title: 'Task Playbook: Security Fix'
status: 'current'
date: '2026-05-27'
owner: 'gtcx-core'
...
1. Identify the trust contract being repaired in `01-docs/architecture/trust-contract-matrix.md`.
...
6. Record evidence using `01-docs/01-agents/workflows/agent-evidence-template.md`.
