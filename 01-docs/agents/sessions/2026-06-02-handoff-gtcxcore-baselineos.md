...
**Action for baseline-os:** Track vendor SOW status. gtcx-core has pen-test RFP drafted (`01-docs/09-security/pen-test-rfp-2026.md`) but vendor not selected.
...
- `gtcx-core/01-docs/05-audit/moat-dimension-roadmap-10-10.md` — full roadmap
- `baseline-os/workstream/coordination/inbound/from-gtcx-core-2026-05-26.md` — original coordination ticket
- `gtcx-core/01-docs/09-security/pen-test-rfp-2026.md` — RFP draft
