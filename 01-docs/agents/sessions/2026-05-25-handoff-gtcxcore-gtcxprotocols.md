...
4. **Tests**
   - 18 new entity predicate assertions in `03-platform/packages/workproof/tests/entity.test.ts`
...
Per `gtcx-intelligence/01-docs/adr/012-predicate-reconciliation-cross-repo.md` §Stage 1:
...
New file: `gtcx-protocols/protocols/tradepass/03-platform/src/predicate-bridge.ts`
