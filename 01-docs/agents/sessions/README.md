...
This directory is `intentionallyNotExcluded` from frontmatter checks per `03-platform/tools/check-doc-frontmatter.mjs` — handoff files use a simpler header convention rather than the full Protocol 1 v2.0 frontmatter schema.
