...
```
03-platform/packages/           TypeScript packages (@gtcx/* scope)
rust/               Rust crates (gtcx-* scope)
03-platform/tools/              Quality gate scripts and automation
...
See `01-docs/devops/runbooks/quality-runbook.md` for the full gate sequence and triage order when a gate fails.
...
| Operations runbooks     | `01-docs/devops/runbooks/`                                                                                              |
| Sprint and roadmap      | `01-docs/05-audit/agile/`                                                                                               |
| Quality evidence        | `quality/`, `benchmarks/`                                                                                               |
| Readiness & audit lanes | `01-docs/01-agents/readiness-and-audit-lanes.md`, `01-docs/05-audit/readiness-model.md`, `01-docs/05-audit/latest.json` |
