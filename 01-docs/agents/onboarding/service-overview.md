...
├── 03-platform/tools/                  # CI and quality automation scripts
└── 01-docs/                   # Standard operating procedures
```
...
| `03-platform/tools/check-package-boundaries.mjs`  | Architecture boundary enforcement                     |
| `03-platform/tools/check-threat-matrix.mjs`       | Security threat matrix check                          |
| `03-platform/tools/check-performance-budgets.mjs` | Performance budget enforcement                        |
