...
**Version:** 1.0.0
**Applies to:** `03-platform/packages/security/`, `03-platform/packages/identity/`
...
**Category:** `audit-trail`
**Severity:** `high`
**References:** `01-docs/09-security/threat-model.md` (TC-004)
...
**Category:** `cryptographic-correctness`
**Severity:** `high`
**References:** `01-docs/09-security/threat-model.md` (TC-010)
