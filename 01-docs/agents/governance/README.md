...
| `review-playbooks/crypto.md`       | 12 checks for `03-platform/packages/crypto/`, `03-platform/packages/crypto-native/`, `rust/gtcx-crypto/`, `rust/gtcx-zkp/` |
| `review-playbooks/security.md`     | 12 checks for `03-platform/packages/security/`, `03-platform/packages/identity/`                                           |
| `review-playbooks/verification.md` | 12 checks for `03-platform/packages/verification/`, `03-platform/packages/workproof/`                                      |
...
- `01-docs/01-agents/roles/crypto-security-engineer.md` — human role definition the bot's playbooks operationalize
- `01-docs/09-security/threat-model.md` — STRIDE table and threat control matrix the playbooks reference
