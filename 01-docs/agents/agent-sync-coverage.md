...
| `01-docs/governance/model-cards/*.md`                      | Model cards                  | Not session entry — governance only         |
...
1. `01-docs/01-agents/readiness-and-audit-lanes.md`
2. `01-docs/05-audit/latest.json`
...
1. Update lane indexes + `01-docs/05-audit/latest.json`
