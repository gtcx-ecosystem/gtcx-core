...
> **Cross-repo:** The **10-document regulator package** (architecture, data residency, IRP, board resolutions) is assembled from **[gtcx-infrastructure `01-docs/08-gtm/sandbox-application/`](https://github.com/gtcx-ecosystem/gtcx-infrastructure/tree/main/01-docs/08-gtm/sandbox-application)** via `assemble-sandbox-evidence.sh`. This guide covers **core-specific** evidence and outreach templates. Full sequencing: [16-ecosystem-gtm-alignment.md](./16-ecosystem-gtm-alignment.md).

---

## The Strategy

The biggest lever is the **pre-submission meeting**. Sandbox teams will tell you exactly what they need. Use the **[canonical sandbox email template](./sandbox-intro-email-template.md)** (not superseded per-country drafts `09`–`13`). Strategy and costs follow the **[Global South 10/10 plan](https://github.com/gtcx-ecosystem/gtcx-infrastructure/blob/main/01-docs/08-gtm/plans/global-south-10x-plan.md)** — regional pen-test ($8–15K), not US bank FFIEC track unless explicitly chosen.
...
| ----------------------------------------- | ---------------------------------------------------------------- | ------------------------------------------------------------- |
| "We need a security assessment"           | Internal assessment document                                     | Done (01-docs/09-security/internal-security-assessment.md)    |
| "We need FIPS compliance"                 | FIPS boundary statement                                          | Done (01-docs/09-security/fips-validation-boundary.md)        |
...
| "We need data protection assessment"      | GDPR assessment                                                  | Done (01-docs/10-compliance/gdpr-assessment.md)               |
| "We need to understand your architecture" | Architecture overview                                            | Done (01-docs/architecture/overview.md)                       |
...
7. **Architecture Overview** — `01-docs/architecture/overview.md`
