...
aligned_with: 'gtcx-infrastructure/01-docs/08-gtm/plans/global-south-10x-plan.md'
---
...
**Evidence base:** README, trust portal, `01-docs/08-gtm/*`, `01-docs/05-audit/ci-confirmation-2026-06-01.md`, infrastructure GTM + EXT-INF register (2026-05-31).  
...
**Evidence:** `README.md` (2026-06-01), `pnpm ci:confirmation` log in `01-docs/05-audit/ci-confirmation-2026-06-01.md`.
...
**Timeline:** 8–12 weeks aligned with [Global South plan](https://github.com/gtcx-ecosystem/gtcx-infrastructure/blob/main/01-docs/08-gtm/plans/global-south-10x-plan.md) (deploy + pen-test + submission).
...
Sovereign deals also need pen-test, testnet, pilot owner (04-ship/GTM) — **deal readiness** on top of Tier 5, not a separate tier.
