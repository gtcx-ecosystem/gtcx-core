---
title: "Modèle d'email d'introduction sandbox (variante française)"
status: 'current'
date: '2026-05-27'
owner: 'gtcx-core'
...
For per-country operational state, see [`01-docs/05-audit/agile/engagement-log/`](../agile/engagement-log/).
...
3. Créer `01-docs/05-audit/agile/engagement-log/2026-{country}-sandbox.md` à partir du [playbook](../agile/engagement-log/playbook.md).
