---
title: 'Pre-Submission Email — Reserve Bank of Zimbabwe'
status: 'current'
date: '2026-05-27'
owner: 'gtcx-core'
...
title: '09 Pre Submission Email Zimbabwe'
status: 'superseded'
date: '2026-05-17'
...
1. **Executive Brief** — `01-docs/08-gtm/00-executive-brief.md`
2. **Security Posture** — `01-docs/08-gtm/01-security-posture.md`
3. **Compliance Matrix** — `01-docs/08-gtm/02-compliance-matrix.md`
4. **FIPS Readiness** — `01-docs/08-gtm/03-fips-readiness.md`
...
5. Take notes on specific evidence requirements — update 01-docs/08-gtm/ accordingly
