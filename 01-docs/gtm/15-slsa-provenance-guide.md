---
title: 'SLSA Provenance Consumer Guide'
status: 'current'
date: '2026-05-27'
owner: 'gtcx-core'
...
**Current status:** Source L2 enforced. Build L3 via `03-platform/tools/publish-packages-provenance.mjs` + `release.yml`. **21/21** core packages attested; **`@gtcx/ai-eval@0.1.4`** added to publish list — run release workflow to complete 22/22. Verify: `pnpm provenance:check-npm:strict`.
