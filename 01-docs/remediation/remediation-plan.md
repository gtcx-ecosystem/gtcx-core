---
title: 'Remediation Plan — gtcx-core (SUPERSEDED)'
status: 'current'
date: '2026-05-27'
owner: 'gtcx-core'
...
tier: 'standard'
tags: ['documentation', 'remediation']
...
> **Status:** Superseded by [`01-docs/05-audit/10-10-remediation-plan-2026-05-27.md`](../audit/10-10-remediation-plan-2026-05-27.md)
...
- `CLAUDE.md`
- `01-docs/01-agents/onboarding/orientation.md`
- `01-docs/01-agents/workflows/safety-rules.md`
- `01-docs/01-agents/roles/quality-evidence-lead.md`
- `01-docs/specs/core-spec.md`
- `01-docs/architecture/overview.md`
- `01-docs/devops/runbooks/quality-runbook.md`
- `01-docs/devops/release-mgmt/release-checklist.md`
- `01-docs/05-audit/*.md`
- `01-docs/09-security/native-binding-audit-checklist.md`
- `01-docs/05-audit/agile/sprints/gtcx-core-definition-of-done.md`
- `01-docs/05-audit/agile/roadmap/10-10-readiness-sprint-roadmap.md`
- `01-docs/01-agents/workflows/tasks/audit-remediation.md`
...
| ----------------------- | --------------------: | ----------------------: | ------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------- |
| Security + compliance   |                8.9/10 |                   10/10 | `01-docs/05-audit/master-audit-2026-05-10.md`                                                          | Strong internal posture; cloud KMS, signed history, and external validation still open                        |
| Code quality            |                9.2/10 |                   10/10 | `01-docs/05-audit/master-audit-2026-05-10.md`                                                          | High quality baseline; maintainability hotspots remain                                                        |
| Architecture            |                9.0/10 |                   10/10 | `01-docs/05-audit/full-audit-2026-05-09.md` + `01-docs/05-audit/master-audit-2026-05-10.md`            | Structure is strong; contract clarity and large-file debt remain                                              |
| Tests                   |                9.0/10 |                   10/10 | `01-docs/05-audit/auto-dev-state.md`                                                                   | Coverage and fuzz posture are strong; HSM and cross-repo contract proof are incomplete                        |
| CI/CD                   |                9.0/10 |                   10/10 | `01-docs/05-audit/auto-dev-state.md`                                                                   | Gates are strong; org-level Actions reliability and secret setup are incomplete                               |
| Production readiness    |                8.8/10 |                   10/10 | `01-docs/05-audit/master-audit-2026-05-10.md`                                                          | Library-grade release posture is strong; external buyer proof is incomplete                                   |
| Ops                     |                9.0/10 |                   10/10 | `01-docs/05-audit/auto-dev-state.md`                                                                   | Runbooks are strong; downstream consumer operability contracts need tightening                                |
| Docs                    |                9.1/10 |                   10/10 | `01-docs/05-audit/docs-standard-compliance-2026-05-10.md`                                              | Canonicalized, but still carries justified drift and prose density issues                                     |
| DX                      |               10.0/10 |                   10/10 | `01-docs/05-audit/auto-dev-state.md`                                                                   | Strong today; must be preserved through enforcement, not assumed                                              |
| GTM                     |              S3 -> S4 | 10/10 evidence-complete | `01-docs/05-audit/full-audit-2026-05-09.md` + `01-docs/05-audit/master-audit-2026-05-10.md`            | Strong packet, weak external proof                                                                            |
| AI / agentic maturity   |       9.1/10 inferred |                   10/10 | `01-docs/05-audit/master-audit-2026-05-10.md` + `01-docs/05-audit/gtcx-ecosystem-rating-2026-05-08.md` | Strong governance pattern, but no repo-local SIGNAL scorecard                                                 |
| Global South resilience |                9.0/10 |                   10/10 | `01-docs/05-audit/master-audit-2026-05-10.md` + `01-docs/05-audit/gtcx-ecosystem-rating-2026-05-08.md` | Offline-first intent is real; persistence and degraded-mode proof lag intent                                  |
| Ecosystem integration   |                6.5/10 |                   10/10 | `01-docs/05-audit/gtcx-ecosystem-rating-2026-05-08.md`                                                 | This is the largest numerical gap                                                                             |
| UX + design             |             Audit gap |       Explicitly scoped | `CLAUDE.md` + `01-docs/specs/core-spec.md`                                                             | No product UI exists in this repo; equivalent surface is API ergonomics and downstream integration experience |
| Innovation gaps         | Not separately scored |                   10/10 | `01-docs/05-audit/full-audit-2026-05-09.md` phase 6.2                                                  | Moat patterns exist, but they are not yet codified as reusable contracts                                      |
...
| ------------------------------- | ---------------------------- | ------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------- | ------ |
| Encryption at rest              | Partial                      | `01-docs/09-security/key-ceremony.md`, `01-docs/09-security/security-framework.md`                                                    | Cloud-managed custody path is not shipped                                                      | 1      |
| Encryption in transit           | Strong                       | `01-docs/09-security/threat-model.md`, `01-docs/09-security/internal-security-assessment.md`                                          | External validation still absent                                                               | 1      |
| Key rotation and revocation     | Strong but partly design-led | `01-docs/09-security/key-ceremony.md`, `01-docs/09-security/pkcs11-keystore.md`                                                       | Cloud KMS and signed-history alignment remain open                                             | 1      |
| KMS / HSM evidence              | Partial                      | `01-docs/09-security/pkcs11-keystore.md`, `01-docs/09-security/cloud-kms-keystore.md`, `rust/gtcx-crypto/03-platform/src/keystore.rs` | Cloud KMS backend and CI proof missing                                                         | 1      |
| Audit logging immutability      | Strong                       | `01-docs/decisions/006-hash-chain-audit-trail.md`, `01-docs/governance/trust-portal.md`                                               | External reviewer proof and retention evidence need consolidation                              | 1, 4   |
| Tamper evidence                 | Strong                       | `artifacts/provenance-manifest.json`, `01-docs/09-security/slsa-attestation.md`                                                       | Source Level 2 not enforced                                                                    | 1      |
| Retention policy                | Partial                      | `01-docs/10-compliance/sox-controls.md`, `01-docs/governance/trust-portal.md`                                                         | Needs explicit linkage for downstream adopters                                                 | 4      |
| Data residency and PII handling | Partial                      | `01-docs/10-compliance/compliance-requirements.md`, `01-docs/10-compliance/pci-dss-scope.md`, `01-docs/10-compliance/sox-controls.md` | Library-vs-platform boundary is documented, but buyer-facing evidence pack is still fragmented | 1, 4   |
| Redaction and secrets hygiene   | Strong                       | `01-docs/governance/trust-portal.md`, `01-docs/04-ops/repo-bootstrap.md`, `01-docs/01-agents/workflows/safety-rules.md`               | Org secret provisioning incomplete                                                             | 1      |
| Supply chain provenance         | Strong                       | `artifacts/provenance-manifest.json`, `01-docs/09-security/slsa-attestation.md`, `.github/workflows/release.yml`                      | Signed history and deterministic workspace packaging need closure                              | 1, 3   |
| SBOM and dependency integrity   | Partial                      | `.github/workflows/ci.yml`, `01-docs/10-compliance/compliance-requirements.md`, `03-platform/tools/check-crypto-deps.mjs`             | Evidence artifact needs repeatable downstream validation path                                  | 3, 8   |
| License and dependency scan     | Strong                       | `01-docs/release/licenses/license-compliance.md`, `.github/workflows/ci.yml`                                                          | External buyer packaging still fragmented                                                      | 10     |
| Separation of duties            | Partial                      | `.github/CODEOWNERS`, `.github/workflows/ai-codeowner-review.yml`, `01-docs/01-agents/workflows/safety-rules.md`                      | Signed commits and durable dual-review evidence remain open                                    | 1, 5   |
| Deploy vs author control        | Partial                      | `01-docs/devops/release-mgmt/release-checklist.md`, `01-docs/release/ga-release/ga-release-checklist.md`                              | Need published-artifact consumption and external approval evidence                             | 3, 4   |
...
| -------------------------------------------- | -------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------- | ------ |
| Offline-first behavior                       | Strong intent, partial proof                 | `01-docs/specs/core-spec.md`, `01-docs/specs/03-platform/packages/sync.md`, `01-docs/08-gtm/07-downstream-integration.md` | No durable queue adapter proof in core                                            | 6      |
| Low-bandwidth behavior                       | Partial                                      | `01-docs/specs/03-platform/packages/sync.md`                                                                              | Connectivity tiers are not yet tied to adaptive batching and retry jitter         | 6      |
| Intermittent connectivity restart recovery   | Partial                                      | `01-docs/05-audit/agile/roadmap/10-10-readiness-sprint-roadmap.md`                                                        | Need constrained-environment CI path and restart tests                            | 6      |
| Low-end device support                       | Partial, downstream-owned                    | `01-docs/05-audit/agile/roadmap/10-10-readiness-sprint-roadmap.md`                                                        | Need explicit boundary for what core guarantees vs what mobile/platform repos own | 6      |
| Graceful degradation with no internet        | Partial                                      | `01-docs/specs/core-spec.md`, `01-docs/specs/03-platform/packages/sync.md`                                                | Need measurable degraded-mode contract                                            | 6      |
...
| Compression / payload discipline             | Weak                                         | `01-docs/05-audit/gtcx-ecosystem-rating-2026-05-08.md`                                                                    | No compression or payload adaptation evidence at foundation level                 | 6      |
| i18n / language surface                      | Downstream-owned, foundation impact indirect | `01-docs/specs/core-spec.md`                                                                                              | Need contract note for locale-safe schemas and error-surface expectations         | 7      |
...
- Rust fmt / clippy / test / fuzz sequence from `01-docs/devops/runbooks/quality-runbook.md`
