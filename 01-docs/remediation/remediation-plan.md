...
| -------------------------------------------- | -------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------- | ------ |
| Offline-first behavior                       | Strong intent, partial proof                 | `01-docs/specs/core-spec.md`, `01-docs/specs/packages/sync.md`, `01-docs/08-gtm/07-downstream-integration.md` | No durable queue adapter proof in core                                            | 6      |
| Low-bandwidth behavior                       | Partial                                      | `01-docs/specs/packages/sync.md`                                                                              | Connectivity tiers are not yet tied to adaptive batching and retry jitter         | 6      |
...
| Graceful degradation with no internet        | Partial                                      | `01-docs/specs/core-spec.md`, `01-docs/specs/packages/sync.md`                                                | Need measurable degraded-mode contract                                            | 6      |
