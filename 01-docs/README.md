...
| [`architecture/structural-debt.md`](./architecture/structural-debt.md)             | Tracked structural debt for `01-docs/` (21 subdirs → 9 target) — deferred consolidation plan                                  |
...
| [`specs/03-platform/packages/README.md`](./specs/03-platform/packages/README.md) | Package-level spec index                         |
...
| [`audit/internal-compliance-2026-06-05.md`](./audit/internal-compliance-2026-06-05.md)                           | Lane 2 — repo hygiene, docs, AI trust, security, corporate readiness                 |
| [`audit/industry-compliance-2026-06-05.md`](./audit/industry-compliance-2026-06-05.md)                           | Lane 3 — Industry Compliance (IC-T0–T4)                                              |
| [`audit/global-compliance-rating-2026-06-05.md`](./audit/global-compliance-rating-2026-06-05.md)                 | **GCR** rollup L2+L3 — **GCR-T0** · **BLOCKED** (not GCI)                            |
| [`audit/latest.json`](./audit/latest.json)                                                                       | Machine-readable lane scores and tiers                                               |
...
| `gtcx-docs/01-docs/governance/protocols/2-repo-setup/protocol.md` (Protocol 2 — version lifecycle) | Versioning and compatibility conventions       |
...
| Document                                                                                                                     | Purpose                                     |
| ---------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------- |
| [`../03-platform/packages/crypto/tests/property-based.test.ts`](../03-platform/packages/crypto/tests/property-based.test.ts) | Example property-based verification surface |
...
The `01-docs/` tree is organized by consumer, not by source team. Directories are retained when they serve a distinct external audience:
...
| [`../03-platform/tools/`](../03-platform/tools/) | Executable utilities and quality gates            |
...
| Where is the package contract?        | [`specs/03-platform/packages/README.md`](./specs/03-platform/packages/README.md)   |
