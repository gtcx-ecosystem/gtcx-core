...
- Quarterly review cadence with sign-off in `01-docs/governance/access-review-<quarter>.md`
...
- New doc: `01-docs/04-ops/vendor-inventory.md`
...
- Document in `01-docs/devops/reproducible-build-attestation.md`
