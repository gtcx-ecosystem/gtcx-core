---
title: 'SOX IT General Controls — gtcx-core'
status: 'current'
date: '2026-05-27'
owner: 'gtcx-core'
...
| Control                                 | Implementation                                                       | Evidence                                   |
| --------------------------------------- | -------------------------------------------------------------------- | ------------------------------------------ |
| Development follows defined methodology | Architecture Decision Records (ADRs) for design decisions            | `01-docs/decisions/` (14 ADRs)             |
...
| Dependencies are managed                | Exact-version pinning for production deps; Dependabot for updates    | `03-platform/packages/*/package.json`      |
...
| Release process is gated         | Release checklist with 26 mandatory checks; human signoff required   | `01-docs/devops/release-mgmt/release-checklist.md` |
| Incidents are tracked            | Quality runbook with failure triage order                            | `01-docs/devops/runbooks/quality-runbook.md`       |
...
| Security-sensitive changes | Cryptographic Security Engineer    | CODEOWNERS path rules for `/03-platform/packages/crypto/`, `/rust/` |
