---
title: 'Developer Setup — gtcx-core'
status: 'current'
date: '2026-05-27'
owner: 'gtcx-core'
...
| Rust    | 1.91       | `rustup toolchain install 1.91-aarch64-apple-darwin` or your platform equivalent |
...
| `pnpm architecture:check` fails      | Circular or boundary-crossing import added       | Check `03-platform/tools/check-package-boundaries.mjs` and fix the import |
