---
title: 'Agent Context Recovery — gtcx-core'
status: 'current'
date: '2026-05-27'
owner: 'gtcx-core'
...
Created at the end of any session with in-progress work. Stored in `01-docs/4-sessions/`.
...
- 13 ADRs in `01-docs/decisions/` capture all significant architectural decisions
...
- Using patterns that contradict `01-docs/code-standards.md` or existing packages
...
| `01-docs/4-sessions/YYYY-MM-DD-handoff.md` | Session handoff             | End of every session with in-progress work        |
| ADRs in `01-docs/decisions/`               | Decision record             | When significant architectural decisions are made |
