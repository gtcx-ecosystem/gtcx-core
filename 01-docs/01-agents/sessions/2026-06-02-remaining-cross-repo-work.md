...
**Source ticket:** `01-docs/08-gtm/inbound-tickets/from-gtcx-infrastructure-eap-auth-keys-sync-2026-06-02.md`
...
1. **D9 audit vendor:** Select vendor from RFP responses (`01-docs/09-security/pen-test-rfp-2026.md`)
