...
| P2.4 | **Refactor gtcx-zkp/03-platform/src/tests.rs (470 LOC)**       | gtcx-core         | frontier-infra-engineer | 2–3h   | None — approaching 500 LOC limit         |
...
| Publish workflow halts                  | Packages not on npm, blocks all downstream | Low        | Standby diagnostics ready; common failure modes documented in `01-docs/internal/external-readiness-checklist.md` | protocol-architect       |
