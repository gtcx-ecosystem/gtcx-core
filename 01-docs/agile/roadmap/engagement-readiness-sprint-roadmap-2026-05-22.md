...
| 3   | Trust portal (`01-docs/governance/trust-portal.md`) does not reference the 2026-05-21 audit, fuzz evidence, or current package readiness — it is the regulator-facing surface                       | Readiness ledger       | Critical | Compliance  | —          |
...
Full task tables, commit plans, and DoD per sprint: [Sprint plan detail](./engagement-readiness-sprint-roadmap-2026-05-22-sprint-plan.md).
...
| ------ | -------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------- |
| 1      | README edit conflicts with concurrent agent work                     | Branch + PR; coordinate via `01-docs/01-agents/sessions/` handoff                                                                 |
...
| 3      | Zimbabwe email contacts have changed                                 | Confirm contact in Sprint 2 via `01-docs/05-audit/agile/engagement-log/`                                                          |
...
## Trust automation (Phase 6)

Post-engagement trust automation track: [Phase 6 detail](./engagement-readiness-trust-automation-phase-6.md).
...
| 1.6 | Master audit refresh (8.8 → 8.9/10)               | ✅ Done         | `01-docs/05-audit/master-audit-2026-05-25.md` delta refresh        |
| 1.7 | GTM pack refresh + new docs                       | ✅ Done         | 6 updated + 3 new (ADR-012 brief, SLSA guide, readiness checklist) |
| 1.5 | Trust portal refresh (2026-05-21 audit + fuzz)    | ✅ Done         | `01-docs/governance/trust-portal.md` updated                       |

### Sprint 2 — Release pipeline proven

| #   | Task                                      | Status      | Evidence                                                                                                                                                    |
| --- | ----------------------------------------- | ----------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2.1 | crypto-native odd-length-hex NAPI fix     | ✅ Done     | `03-platform/packages/crypto-native/03-platform/src/index.ts` — `assertHex` / `isHex` wrappers; 19 hex-validation tests                                     |
...
| 2.5 | Trust portal "Published versions" section | ✅ Complete | `01-docs/governance/trust-portal.md` updated with live `npm view` versions.                                                                                 |
...
| #   | Task                                       | Status     | Evidence                                                                                                                                                                              |
| --- | ------------------------------------------ | ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 4.1 | Pen test RFP drafted + vendor longlist     | ✅ Drafted | [`01-docs/09-security/pen-test-rfp-2026.md`](../../security/pen-test-rfp-2026.md) + [engagement log](../../security/pen-test-engagement-log.md). **User-blocked:** vendor outreach    |
| 4.2 | SOC 2 Type 1 readiness prep + CPA criteria | ✅ Drafted | [`01-docs/10-compliance/soc2-readiness-prep.md`](../../compliance/soc2-readiness-prep.md) + [engagement log](../../compliance/soc2-engagement-log.md). **User-blocked:** CPA outreach |
| 4.3 | ark-\* upstream advisory tracker           | ✅ Done    | [`01-docs/09-security/ark-upstream-tracking.md`](../../security/ark-upstream-tracking.md)                                                                                             |
