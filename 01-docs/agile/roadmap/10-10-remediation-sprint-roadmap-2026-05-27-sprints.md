...
| ID      | Task                                                                          | Effort | Status   | Blocked By |
| ------- | ----------------------------------------------------------------------------- | ------ | -------- | ---------- |
| HYG-005 | Add `MATURITY: Scaffolding` badge to `03-platform/packages/ai/README.md`      | 0.5d   | **DONE** | —          |
| DOC-004 | Fix `01-docs/quality/10-10-remediation-tracker.md` KPIs                       | 0.5d   | Open     | —          |
| NEW-003 | Populate `01-docs/05-audit/agile/sprints/current.md` with S46 committed items | 0.5d   | Open     | —          |
...
- [ ] `01-docs/05-audit/agile/sprints/current.md` populated with actual committed work
...
| ECO-002 | Add closure dates to `01-docs/05-audit/agile/cross-repo-coordination.md` | 0.5d   | Protocol Architect | —            |
| NEW-002 | Fix `01-docs/quality/10-10-remediation-tracker.md` KPIs                  | 0.5d   | Quality Lead       | —            |

### Swimlane: Docs

| ID      | Task                                                         | Effort | Owner                | Dependencies    |
| ------- | ------------------------------------------------------------ | ------ | -------------------- | --------------- |
| DOC-003 | Write `01-docs/quality/performance-budget-analysis.md`       | 1d     | Performance Engineer | ENT-002 data    |
| DOC-002 | Update SLSA guide with real attestations (if unblocked)      | 0.5d   | Docs Lead            | SLSA provenance |
| DOC-001 | Execute or archive `01-docs/remediation/remediation-plan.md` | 2d     | Protocol Architect   | —               |
...
| GTM-005 | Create `01-docs/08-gtm/case-studies/README.md` placeholder | 0.5d   | GTM Lead | —                |
