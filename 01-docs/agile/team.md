...
This squad manages all `gtcx-core` work in ClickUp. Source of truth for sprint commitments and backlog priority is git (`01-docs/05-audit/agile/`), but ClickUp is the operational execution layer.
