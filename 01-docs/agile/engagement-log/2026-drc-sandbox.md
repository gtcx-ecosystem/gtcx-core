...
The send-ready French render (every `{{placeholder}}` substituted, copy-paste-ready) lives at [`01-docs/08-gtm/renders/drc-2026.fr.md`](../../gtm/renders/drc-2026.fr.md). **French-fluent review required before send.**
