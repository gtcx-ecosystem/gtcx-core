...
**Draft:** [`01-docs/08-gtm/09-pre-submission-email-zimbabwe.md`](../gtm/09-pre-submission-email-zimbabwe.md)
...
5. Attach (as PDFs when ready):
   - `01-docs/08-gtm/00-executive-brief.md`
   - `01-docs/08-gtm/01-security-posture.md`
   - `01-docs/08-gtm/02-compliance-matrix.md`
   - `01-docs/08-gtm/03-fips-readiness.md`
...
cp 01-docs/08-gtm/09-pre-submission-email-zimbabwe.md 01-docs/08-gtm/responses/zimbabwe-2026-05-11.md
...
- Track regulator responses in `01-docs/08-gtm/responses/`
