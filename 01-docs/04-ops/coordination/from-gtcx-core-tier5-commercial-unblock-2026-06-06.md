...
| **Class S (human only)** | **DTF-5.5.4** LOI or regulator letter in `01-docs/05-audit/evidence/`                                                  | **Approval needed** — never sign or fabricate |
...
Ecosystem norm: [human-evidence-gates-unblock-2026-06-06.md](https://github.com/gtcx-ecosystem/gtcx-protocols/blob/main/01-docs/04-ops/coordination/human-evidence-gates-unblock-2026-06-06.md) (F11–F13 pattern); core commercial gate = **F14** in [ecosystem-unblock-playbook](https://github.com/gtcx-ecosystem/gtcx-protocols/blob/main/01-docs/04-ops/coordination/ecosystem-unblock-playbook-2026-06.md).
...
- **gtcx-protocols:** witness DTF-5.5.4 LOI in `01-docs/05-audit/evidence/` when redacted PDF available — do not duplicate manifest here
