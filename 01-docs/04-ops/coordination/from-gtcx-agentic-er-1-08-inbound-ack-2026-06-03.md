...
| Resource   | Path                                                                                                               |
| ---------- | ------------------------------------------------------------------------------------------------------------------ |
| Runbook    | [01-docs/devops/runbooks/eap-staging-issuance-ceremony.md](../../devops/runbooks/eap-staging-issuance-ceremony.md) |
| CLI        | `cd 03-platform/packages/eap && EAP_PERSIST_EVIDENCE=1 pnpm eap:ceremony`                                          |
...
| Event  | File                                                                                                                                                                  |
| ------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| issue  | [01-docs/05-audit/evidence/eap-issuance-2026-06-03-issue-er-1-08-staging-proof.json](../../audit/evidence/eap-issuance-2026-06-03-issue-er-1-08-staging-proof.json)   |
| revoke | [01-docs/05-audit/evidence/eap-issuance-2026-06-03-revoke-er-1-08-staging-proof.json](../../audit/evidence/eap-issuance-2026-06-03-revoke-er-1-08-staging-proof.json) |

**Validator (exit 0):**

```bash
node ../gtcx-protocols/03-platform/tools/validate-eap-issuance-evidence.mjs 01-docs/05-audit/evidence
```
...
**Canonical intelligence copy (prior smoke):** `gtcx-intelligence/01-docs/05-audit/evidence/eap-issuance-2026-06-02-issue-smoke-2026-06-rotated.json`
...
| Item                              | Value                                                                 |
| --------------------------------- | --------------------------------------------------------------------- |
| Validator                         | `gtcx-protocols/03-platform/tools/validate-eap-issuance-evidence.mjs` |
| CI command                        | `pnpm check:eap-issuance-evidence` (protocols repo root)              |
| Canonical glob (intelligence SoR) | `gtcx-intelligence/01-docs/05-audit/evidence/eap-issuance-*.json`     |
| gtcx-core ceremony glob           | `gtcx-core/01-docs/05-audit/evidence/eap-issuance-*.json` (this ack)  |

Cross-repo check from protocols:

```bash
pnpm check:eap-issuance-evidence -- ../gtcx-intelligence/01-docs/05-audit/evidence
pnpm check:eap-issuance-evidence -- ../gtcx-core/01-docs/05-audit/evidence
```
...
| 2   | Redacted issuance JSON    | **done** — `01-docs/05-audit/evidence/eap-issuance-2026-06-03-*` |
...
**Repo:** `gtcx-protocols` · **File:** `01-docs/04-ops/coordination/cross-repo-agent-log.md`

| Timestamp (UTC)   | Repo      | Work ID | Status | Summary                                                                                                                      | Evidence                                                                                             |
| ----------------- | --------- | ------- | ------ | ---------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- |
| 2026-06-04T23:00Z | gtcx-core | ER-1-08 | done   | EAP staging issue/revoke ceremony; redacted `eap-issuance-2026-06-03-*` under `01-docs/05-audit/evidence/`; region SoR in §3 | `01-docs/04-ops/coordination/from-gtcx-agentic-er-1-08-inbound-ack-2026-06-03.md` · commit `ba63d0d` |
