...
| Supply chain                | SA-12, SR-3        | CC9.2         | `pnpm.overrides` exact-pinning; `03-platform/tools/check-crypto-deps.mjs` integrity allowlist; SBOM (CycloneDX) on every build              |
...
- Property-based tests — 25 properties × 50-100 runs each in [`03-platform/packages/crypto/tests/property-based.test.ts`](../../03-platform/packages/crypto/tests/property-based.test.ts)
...
- [Crypto dependency allowlist](../../03-platform/tools/check-crypto-deps.mjs) — pinned versions + sha512 integrity hashes for `@noble/*`
- [Reproducible-build verifier](../../03-platform/tools/check-reproducible-build.mjs) — `pnpm build:reproducible`
...
- [Repo bootstrap](../operations/repo-bootstrap.md) — auto-generated from `03-platform/tools/check-ops-prereqs.mjs`
...
The output is also auto-written to [`01-docs/04-ops/repo-bootstrap.md`](../operations/repo-bootstrap.md) via `pnpm ops:emit-doc`.
