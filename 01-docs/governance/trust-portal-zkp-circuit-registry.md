...
Implementation: [`rust/gtcx-zkp/03-platform/src/circuit_profiles/validate.rs`](../../rust/gtcx-zkp/03-platform/src/circuit_profiles/validate.rs) · full-audit finding closed by this section ([full-audit-2026-06-04.md](../audit/full-audit-2026-06-04.md)).
...
Reproduce: `pnpm perf:zkp-profile-load` (writes dated JSON under `01-docs/05-audit/evidence/`).
