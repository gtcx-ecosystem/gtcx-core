...
- **Never** allows Claude to modify `01-docs/09-security/threat-control-matrix.md` without human sign-off
...
- All changes to `03-platform/packages/crypto/`, `03-platform/packages/security/`, `03-platform/packages/verification/`, `03-platform/packages/identity/`, `rust/gtcx-crypto/`, `rust/gtcx-zkp/` require `crypto-security-engineer` review
