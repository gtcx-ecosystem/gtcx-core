...
- **Extreme context window**: Can ingest entire repo documentation (all `01-docs/` files) in a single prompt
...
2. **Diagram generation**: Architecture diagrams from `01-docs/architecture/overview.md`
