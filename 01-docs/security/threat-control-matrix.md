...
| T03 | Secret leakage in logs (Info Disclosure)  | Secret redaction in traced operations                       | ✅     | `03-platform/packages/ai/03-platform/src/redaction.ts`, `03-platform/packages/logging/03-platform/src/logger.ts` | 2026-05-12    |
...
| T06 | ZKP proof forgery                         | Hash-commitment engine fails closed by default              | ✅     | `03-platform/packages/crypto/03-platform/src/zkp.ts`, `01-docs/09-security/threat-model.md`                      | 2026-05-12    |
| T07 | Offline data tampering                    | AES-GCM-encrypted offline queue with integrity verification | ✅     | `03-platform/packages/domain/03-platform/src/internal/offline-queue.ts`                                          | 2026-05-12    |
...
| T10 | Production key export                     | `production-guard` tier + Secure Enclave / Keystore path    | ⚠️     | `rust/gtcx-crypto/03-platform/src/keystore.rs`                                                                   | 2026-05-12    |
| T11 | Penetration test coverage                 | Third-party pen-test scoped, vendor not engaged             | 🔴     | `01-docs/09-security/pen-test-scope.md`                                                                          | —             |
| T12 | SOC 2 attestation                         | Readiness analysis complete, CPA engagement pending         | 🔴     | `01-docs/10-compliance/soc2-readiness.md`                                                                        | —             |
