...
| T06 | ZKP proof forgery                         | Hash-commitment engine fails closed by default              | ✅     | `03-platform/packages/crypto/src/zkp.ts`, `01-docs/09-security/threat-model.md`                      | 2026-05-12    |
