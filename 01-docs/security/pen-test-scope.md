...
| ------------------------------------------- | --------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------- |
| Cryptographic signing surfaces              | Signature forgery and malformed-input handling are consequential            | `03-platform/packages/crypto/`, `rust/gtcx-crypto/`, `01-docs/09-security/attack-tree-signing.md`                                     |
| Verification and certificate flow           | Verification decisions and revocation behavior are trust-bearing            | `03-platform/packages/verification/`, `01-docs/09-security/internal-security-assessment.md`                                           |
| Native binding boundary                     | JS -> Rust boundary is memory- and input-safety sensitive                   | `rust/gtcx-node/`, `01-docs/09-security/native-binding-audit-checklist.md`                                                            |
| Key management abstractions                 | HSM / PKCS#11 / cloud-KMS lifecycle semantics matter to institutional users | `rust/gtcx-crypto/03-platform/src/keystore.rs`, `01-docs/09-security/pkcs11-keystore.md`, `01-docs/09-security/cloud-kms-keystore.md` |
| Supply chain and build provenance           | Library trust depends on tamper-evident build and dependency integrity      | `.github/workflows/`, `artifacts/provenance-manifest.json`, `01-docs/09-security/slsa-attestation.md`                                 |
| Observability redaction and trust telemetry | Trace output must not leak secrets or create false trust signals            | `03-platform/packages/ai/`, `01-docs/governance/trust-portal.md`                                                                      |
...
- Medium findings require a tracked remediation item in `01-docs/remediation/remediation-plan.md`.
