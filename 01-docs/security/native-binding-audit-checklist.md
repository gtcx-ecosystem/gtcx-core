---
title: 'Native Binding Safety Audit Checklist'
status: 'current'
date: '2026-05-27'
owner: 'gtcx-core'
...
**Scope:** `@gtcx/crypto-native` NAPI-RS bindings (`rust/gtcx-node/03-platform/src/lib.rs`)
...
| No `unsafe` blocks in `gtcx-node`              | ✅ Pass | Verified by `grep -rn 'unsafe' rust/gtcx-node/03-platform/src/` — 0 matches. |
...
- `rust/gtcx-node/03-platform/src/lib.rs` — binding source
- `03-platform/packages/crypto-native/03-platform/src/index.ts` — JS wrapper
