---
title: 'NIST 800-53 Rev 5 Control Mapping — gtcx-core'
status: 'current'
date: '2026-05-27'
owner: 'gtcx-core'
...
| CM-3    | Configuration Change Control   | Architecture boundary enforcement blocks unauthorized cross-package imports | `03-platform/tools/check-package-boundaries.mjs`               |
...
| SA-15   | Development Process, Standards, and Tools | 13 ADRs documenting all architectural decisions; 4 agent roles with safety rules | `01-docs/decisions/`, `01-docs/01-agents/roles/`            |
...
- `01-docs/09-security/threat-control-matrix.md` — 12 threat controls
- `01-docs/09-security/fips-assessment.md` — FIPS compliance pathway
- `01-docs/09-security/security-framework.md` — Security architecture
