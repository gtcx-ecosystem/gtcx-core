---
title: 'External Penetration Test — RFP 2026'
status: 'current'
date: '2026-05-27'
owner: 'gtcx-core'
...
2. **Pre-engagement briefing** — vendor reviews our threat model (`01-docs/09-security/threat-model.md`), attack tree (`01-docs/09-security/attack-tree-signing.md`), and architecture (`01-docs/architecture/overview.md`) before testing.
