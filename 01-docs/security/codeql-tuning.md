...
- **Included paths:** `03-platform/packages/`, `rust/`
...
| `ts/unsafe-assignment-from-any`   | Covered by the stricter `any`-annotation budget gate (`03-platform/tools/check-governance.mjs`).    |
