...
export const LAUNCH_DOC = 'docs/operations/agent-launch-focus.md';
...
const NORTH_STAR = {
  ...
  notTheGoal: 'Re-run forensic audits or story menus to discover priorities — launch-focus.json is SoR.',
};
...
function parseGtmTiers(latestJson) {
  try {
    ...
    return {
      ...
      index: j?.lanes?.gtmReadiness?.index ?? 'docs/audit/gtm-readiness-2026-06-05.md',
    };
  } catch {
    return {
      library: 'GR-T1',
      ...
      index: 'docs/audit/gtm-readiness-2026-06-05.md',
    };
  }
}
...
const PLANNING_QUEUE = [
  ...
  },
  {
    ...
    workClass: 'ops-docs',
    authorityClass: 'S',
    paths: ['docs/audit/execution-roadmap.md'],
    lane: 'launch-planning',
  },
  {
    ...
    workClass: 'ops-docs',
    authorityClass: 'S',
    paths: ['docs/operations/coordination/cross-repo-agent-bridge.md'],
    lane: 'launch-planning',
  },
  {
    ...
    workClass: 'ops-docs',
    authorityClass: 'S',
    paths: ['docs/operations/coordination/remaining-cross-repo-work-2026-06-02.md'],
    lane: 'cross-repo-gtm',
  },
  {
...
export function buildLaunchFocus(repoRoot) {
  ...
  const workplan = readUtf8(repoRoot, 'docs/operations/tier-5-workplan-2026-06.md');
  const executionMd = readUtf8(repoRoot, 'docs/audit/execution-roadmap.md');
  const remainingMd = readUtf8(
    repoRoot,
    'docs/operations/coordination/remaining-cross-repo-work-2026-06-02.md',
  );
  const latestJson = readUtf8(repoRoot, 'docs/audit/latest.json');
  ...
  return {
    ...
    activePhase: {
      ...
      executionRoadmap: 'docs/audit/execution-roadmap.md',
...
export function attachLaunchFocus(nextWork, repoRoot) {
  ...
  launchFocus.workSet.human = dedupeById(
    humanGates(
      nextWork,
      readUtf8(repoRoot, 'docs/operations/tier-5-workplan-2026-06.md'),
      readUtf8(repoRoot, 'docs/audit/execution-roadmap.md'),
    ),
  );
